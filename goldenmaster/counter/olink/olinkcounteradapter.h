...
*/
class OLinkCounterAdapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkCounterAdapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractCounter* impl, QObject *parent = nullptr);
    virtual ~OLinkCounterAdapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a Counter that gets adapted to objectlink with OLinkCounterAdapter.
    */
    AbstractCounter* m_impl;
    /**
