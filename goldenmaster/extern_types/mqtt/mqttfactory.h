...
/** 
* A Factory that creates a MqttClient version of interfaces in extern_types
...
class EXTERN_TYPES_MQTT_LIBRARY_EXPORT MqttFactory : public QObject, public IApiFactory
{
public:
