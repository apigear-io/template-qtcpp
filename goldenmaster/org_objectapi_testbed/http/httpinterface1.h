...
class HttpInterface1 : public AbstractInterface1
{
    Q_OBJECT
public:
    explicit HttpInterface1(QNetworkAccessManager *network, QObject *parent = nullptr);
    virtual ~HttpInterface1() override;
