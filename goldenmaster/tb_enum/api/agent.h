...
public:
  ...
  static void trace_func0(AbstractEnumInterface* obj, const Enum0::Enum0Enum param0);
  static void trace_func1(AbstractEnumInterface* obj, const Enum1::Enum1Enum param1);
