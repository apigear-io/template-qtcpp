...
*/
class OLinkEnumInterfaceAdapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkEnumInterfaceAdapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractEnumInterface* impl, QObject *parent = nullptr);
    virtual ~OLinkEnumInterfaceAdapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a EnumInterface that gets adapted to objectlink with OLinkEnumInterfaceAdapter.
    */
