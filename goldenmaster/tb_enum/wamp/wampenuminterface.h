...
class WampEnumInterface : public AbstractEnumInterface
{
    Q_OBJECT
public:
    explicit WampEnumInterface(QObject *parent = nullptr);
    virtual ~WampEnumInterface() override;
...
void notifySig0(WAMP::EventArg arg);
