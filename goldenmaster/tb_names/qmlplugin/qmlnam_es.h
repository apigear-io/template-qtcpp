...
#if defined(TB_NAMES_QML_LIBRARY)
#  define TB_NAMES_QML_EXPORT Q_DECL_EXPORT
#else
#  define TB_NAMES_QML_EXPORT Q_DECL_IMPORT
#endif
...
*/
class TB_NAMES_QML_EXPORT QmlNamEs : public AbstractNamEs
{
    Q_OBJECT
    QML_NAMED_ELEMENT(TbNamesNamEs)
