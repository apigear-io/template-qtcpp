...
inline TB_SAME1_API_EXPORT QDataStream& operator<<(QDataStream &ds, const Enum1::Enum1Enum &obj)
{
    quint8 val = obj;
    ds << val;
    return ds;
...
inline TB_SAME1_API_EXPORT QDataStream& operator>>(QDataStream &ds, Enum1::Enum1Enum &obj) {
    bool ok;
    quint8 val;
    ds >> val;
...
inline TB_SAME1_API_EXPORT QDataStream& operator<<(QDataStream &ds, const Enum2::Enum2Enum &obj)
{
    quint8 val = obj;
    ds << val;
    return ds;
...
inline TB_SAME1_API_EXPORT QDataStream& operator>>(QDataStream &ds, Enum2::Enum2Enum &obj) {
    bool ok;
    quint8 val;
    ds >> val;
...
TB_SAME1_API_EXPORT QDataStream& operator<<(QDataStream &stream, const Struct1 &obj);
/** istream operator. Allows reading to Struct1 value from input text*/
TB_SAME1_API_EXPORT QDataStream& operator>>(QDataStream &stream, Struct1 &obj);
...
TB_SAME1_API_EXPORT QDataStream& operator<<(QDataStream &stream, const Struct2 &obj);
/** istream operator. Allows reading to Struct2 value from input text*/
TB_SAME1_API_EXPORT QDataStream& operator>>(QDataStream &stream, Struct2 &obj);
