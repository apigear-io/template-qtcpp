...
void SameStruct1InterfaceAgent::trace_sig1(AbstractSameStruct1Interface* obj, const Struct1& param1)
{
    ...
    ApiGear::Monitor::AgentClient::instance()->traceSignal("tb.same1.SameStruct1Interface#sig1", params_);
}
...
void SameStruct2InterfaceAgent::trace_sig1(AbstractSameStruct2Interface* obj, const Struct1& param1)
{
    ...
    ApiGear::Monitor::AgentClient::instance()->traceSignal("tb.same1.SameStruct2Interface#sig1", params_);
}
void SameStruct2InterfaceAgent::trace_sig2(AbstractSameStruct2Interface* obj, const Struct1& param1, const Struct2& param2)
{
    ...
    ApiGear::Monitor::AgentClient::instance()->traceSignal("tb.same1.SameStruct2Interface#sig2", params_);
}
...
void SameEnum1InterfaceAgent::trace_sig1(AbstractSameEnum1Interface* obj, Enum1::Enum1Enum param1)
{
    ...
    ApiGear::Monitor::AgentClient::instance()->traceSignal("tb.same1.SameEnum1Interface#sig1", params_);
}
...
void SameEnum2InterfaceAgent::trace_sig1(AbstractSameEnum2Interface* obj, Enum1::Enum1Enum param1)
{
    ...
    ApiGear::Monitor::AgentClient::instance()->traceSignal("tb.same1.SameEnum2Interface#sig1", params_);
}
void SameEnum2InterfaceAgent::trace_sig2(AbstractSameEnum2Interface* obj, Enum1::Enum1Enum param1, Enum2::Enum2Enum param2)
{
    ...
    ApiGear::Monitor::AgentClient::instance()->traceSignal("tb.same1.SameEnum2Interface#sig2", params_);
}
