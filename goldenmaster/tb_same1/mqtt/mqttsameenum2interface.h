...
/**
* Adapts the general Mqtt Client handler to a SameEnum2Interface in a way it provides access
...
*/
class TB_SAME1_MQTT_LIBRARY_EXPORT MqttSameEnum2Interface : public AbstractSameEnum2Interface
{
    Q_OBJECT
public:
    /** ctor */
    explicit MqttSameEnum2Interface(ApiGear::Mqtt::Client& client, QObject *parent = nullptr);
    /** dtor */
    ~MqttSameEnum2Interface() override;
    /**
    * Property getter
...
private:
    // Helper function, subscribes for property changes from the remote SameEnum2Interface service.
    void subscribeForPropertiesChanges();
    // Helper function, subscribes for signals emitted by the remote SameEnum2Interface service.
    void subscribeForSignals();
    // Helper function, subscribes for result of invoke on remote SameEnum2Interface service.
