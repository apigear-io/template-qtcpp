...
namespace
{
const QString ID = "tb.same1/SameStruct1Interface";
}
...
void MqttSameStruct1Interface::setProp1Local(const nlohmann::json& input)
{
    AG_LOG_DEBUG(Q_FUNC_INFO);
    auto in_prop1(input.get<Struct1>());
    if (m_prop1 != in_prop1)
    {
        m_prop1 = in_prop1;
...
const QString& MqttSameStruct1Interface::objectName()
{
    return ID;
}
