...
class OLinkSameEnum1InterfaceAdapter : public QObject, public IObjectSource
{
    Q_OBJECT
public:
    explicit OLinkSameEnum1InterfaceAdapter(RemoteRegistry& registry, AbstractSameEnum1Interface* impl, QObject *parent = nullptr);
