...
public:
    ...
    */
    explicit OLinkSameEnum1InterfaceAdapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractSameEnum1Interface* impl, QObject *parent = nullptr);
    virtual ~OLinkSameEnum1InterfaceAdapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a SameEnum1Interface that gets adapted to objectlink with OLinkSameEnum1InterfaceAdapter.
    */
