...
*/
class TB_SAME1_QML_EXPORT QmlSameEnum2Interface : public AbstractSameEnum2Interface
{
    Q_OBJECT
    QML_NAMED_ELEMENT(TbSame1SameEnum2Interface)
    ...
    */
    Q_PROPERTY(tb_same1::Enum2::Enum2Enum prop2 READ prop2 WRITE setProp2 NOTIFY prop2Changed)
public:
    ...
    */
    tb_same1::Enum2::Enum2Enum prop2() const override;
    /*
    ...
    */
    void setProp2(tb_same1::Enum2::Enum2Enum prop2) override;
    ...
    *   
    */
    Q_INVOKABLE tb_same1::Enum1::Enum1Enum func2(tb_same1::Enum1::Enum1Enum param1, tb_same1::Enum2::Enum2Enum param2) override;
...
Q_SIGNALS:
    ...
    void prop2Changed(tb_same1::Enum2::Enum2Enum prop2);
private:
    /**
