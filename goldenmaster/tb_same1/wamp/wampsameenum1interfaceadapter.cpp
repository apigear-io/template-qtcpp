...
{    
    ...
    WampClient::instance()->doRegister("tb.same1.SameEnum1Interface._get", [this](ProcedureArg arg) {
        this->handleGetState(arg);
    });
    WampClient::instance()->doRegister("tb.same1.SameEnum1Interface._set", [this](ProcedureArg arg) {
        this->handleSetState(arg);
    });

    // setup operations
    WampClient::instance()->doRegister("tb.same1.SameEnum1Interface.func1", [this](ProcedureArg arg) {
...
void WampSameEnum1InterfaceAdapter::publishState()
{
    ...
    WampClient::instance()->doPublish("tb.same1.SameEnum1Interface", json::array(), fields);
}
...
void WampSameEnum1InterfaceAdapter::publishSig1(const Enum1::Enum1Enum param1)
{
    ...
    WampClient::instance()->doPublish("tb.same1.SameEnum1Interface.", args, json::object());
}
