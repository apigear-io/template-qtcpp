...
{    
    ...
    WampClient::instance()->doCall("tb.same1.SameEnum2Interface._get", json::array(), json::object(), [this](WAMP::ResponseArg arg) {
        this->applyState(arg.kwargs);
    });

    // subscribe to state changes
    WampClient::instance()->doSubscribe("tb.same1.SameEnum2Interface", [this](WAMP::EventArg arg) {
        this->applyState(arg.kwargs);
    });
    // subscribe to signal sig1
    WampClient::instance()->doSubscribe("tb.same1.SameEnum2Interface.sig1", [this](WAMP::EventArg arg) {
        this->notifySig1(arg);
    });
    // subscribe to signal sig2
    WampClient::instance()->doSubscribe("tb.same1.SameEnum2Interface.sig2", [this](WAMP::EventArg arg) {
        this->notifySig2(arg);
    });
}
...
void WampSameEnum2Interface::setProp1(const Enum1::Enum1Enum prop1)
{
    ...
    WampClient::instance()->doCall("tb.same1.SameEnum2Interface._set", json::array(), fields);
}
...
QtPromise::QPromise<Enum1::Enum1Enum> WampSameEnum2Interface::func1Async(const Enum1::Enum1Enum param1)
{
    return QtPromise::QPromise<Enum1::Enum1Enum>{[&](
        const QtPromise::QPromiseResolve<Enum1::Enum1Enum>& resolve) {
            WampClient::instance()->doCall("tb.same1.SameEnum2Interface.func1", json::array({param1}), json::object(), [resolve](WAMP::ResponseArg arg) {                
...
QtPromise::QPromise<Enum1::Enum1Enum> WampSameEnum2Interface::func2Async(const Enum1::Enum1Enum param1, const Enum2::Enum2Enum param2)
{
    return QtPromise::QPromise<Enum1::Enum1Enum>{[&](
        const QtPromise::QPromiseResolve<Enum1::Enum1Enum>& resolve) {
            WampClient::instance()->doCall("tb.same1.SameEnum2Interface.func2", json::array({param1,param2}), json::object(), [resolve](WAMP::ResponseArg arg) {                
                const Enum1::Enum1Enum& result = arg.args[0].get<Enum1::Enum1Enum>();
                resolve(result);
            });
        }
