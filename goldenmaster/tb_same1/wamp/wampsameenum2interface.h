...
class WampSameEnum2Interface : public AbstractSameEnum2Interface
{
    Q_OBJECT
public:
    explicit WampSameEnum2Interface(QObject *parent = nullptr);
    virtual ~WampSameEnum2Interface() override;
