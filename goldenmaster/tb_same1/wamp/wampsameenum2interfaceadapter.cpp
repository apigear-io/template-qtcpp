...
{    
    ...
    WampClient::instance()->doRegister("tb.same1.SameEnum2Interface._get", [this](ProcedureArg arg) {
        this->handleGetState(arg);
    });
    WampClient::instance()->doRegister("tb.same1.SameEnum2Interface._set", [this](ProcedureArg arg) {
        this->handleSetState(arg);
    });

    // setup operations
    WampClient::instance()->doRegister("tb.same1.SameEnum2Interface.func1", [this](ProcedureArg arg) {
        this->handleFunc1(arg);
    });
    WampClient::instance()->doRegister("tb.same1.SameEnum2Interface.func2", [this](ProcedureArg arg) {
...
void WampSameEnum2InterfaceAdapter::publishState()
{
    ...
    WampClient::instance()->doPublish("tb.same1.SameEnum2Interface", json::array(), fields);
}
...
void WampSameEnum2InterfaceAdapter::publishSig1(const Enum1::Enum1Enum param1)
{
    ...
    WampClient::instance()->doPublish("tb.same1.SameEnum2Interface.", args, json::object());
}
