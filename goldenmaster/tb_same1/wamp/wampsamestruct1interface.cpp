...
{    
    ...
    WampClient::instance()->doCall("tb.same1.SameStruct1Interface._get", json::array(), json::object(), [this](WAMP::ResponseArg arg) {
        this->applyState(arg.kwargs);
    });

    // subscribe to state changes
    WampClient::instance()->doSubscribe("tb.same1.SameStruct1Interface", [this](WAMP::EventArg arg) {
        this->applyState(arg.kwargs);
    });
    // subscribe to signal sig1
    WampClient::instance()->doSubscribe("tb.same1.SameStruct1Interface.sig1", [this](WAMP::EventArg arg) {
        this->notifySig1(arg);
    });
}
...
void WampSameStruct1Interface::setProp1(const Struct1& prop1)
{
    ...
    WampClient::instance()->doCall("tb.same1.SameStruct1Interface._set", json::array(), fields);
}
...
QtPromise::QPromise<Struct1> WampSameStruct1Interface::func1Async(const Struct1& param1)
{
    return QtPromise::QPromise<Struct1>{[&](
        const QtPromise::QPromiseResolve<Struct1>& resolve) {
            WampClient::instance()->doCall("tb.same1.SameStruct1Interface.func1", json::array({param1}), json::object(), [resolve](WAMP::ResponseArg arg) {                
