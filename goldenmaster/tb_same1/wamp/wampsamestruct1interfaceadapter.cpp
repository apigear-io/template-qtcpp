...
{    
    ...
    WampClient::instance()->doRegister("tb.same1.SameStruct1Interface._get", [this](ProcedureArg arg) {
        this->handleGetState(arg);
    });
    WampClient::instance()->doRegister("tb.same1.SameStruct1Interface._set", [this](ProcedureArg arg) {
        this->handleSetState(arg);
    });

    // setup operations
    WampClient::instance()->doRegister("tb.same1.SameStruct1Interface.func1", [this](ProcedureArg arg) {
...
void WampSameStruct1InterfaceAdapter::publishState()
{
    ...
    WampClient::instance()->doPublish("tb.same1.SameStruct1Interface", json::array(), fields);
}
...
void WampSameStruct1InterfaceAdapter::publishSig1(const Struct1& param1)
{
    ...
    WampClient::instance()->doPublish("tb.same1.SameStruct1Interface.", args, json::object());
}
