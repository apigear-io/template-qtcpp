...
{    
    ...
    WampClient::instance()->doRegister("tb.same1.SameStruct2Interface._get", [this](ProcedureArg arg) {
        this->handleGetState(arg);
    });
    WampClient::instance()->doRegister("tb.same1.SameStruct2Interface._set", [this](ProcedureArg arg) {
        this->handleSetState(arg);
    });

    // setup operations
    WampClient::instance()->doRegister("tb.same1.SameStruct2Interface.func1", [this](ProcedureArg arg) {
        this->handleFunc1(arg);
    });
    WampClient::instance()->doRegister("tb.same1.SameStruct2Interface.func2", [this](ProcedureArg arg) {
...
void WampSameStruct2InterfaceAdapter::publishState()
{
    ...
    WampClient::instance()->doPublish("tb.same1.SameStruct2Interface", json::array(), fields);
}
...
void WampSameStruct2InterfaceAdapter::publishSig1(const Struct1& param1)
{
    ...
    WampClient::instance()->doPublish("tb.same1.SameStruct2Interface.", args, json::object());
}
