...
#if defined(TB_SAME2_LIBRARY)
#  define TB_SAME2_EXPORT Q_DECL_EXPORT
#else
#  define TB_SAME2_EXPORT Q_DECL_IMPORT
#endif
...
class TB_SAME2_EXPORT AbstractSameStruct1Interface : public QObject {
    Q_OBJECT
public:
...
class TB_SAME2_EXPORT AbstractSameStruct2Interface : public QObject {
    Q_OBJECT
public:
...
class TB_SAME2_EXPORT AbstractSameEnum1Interface : public QObject {
    Q_OBJECT
public:
...
class TB_SAME2_EXPORT AbstractSameEnum2Interface : public QObject {
    Q_OBJECT
public:
...
Q_DECLARE_METATYPE(tb_same2::Enum1::Enum1Enum)
Q_DECLARE_METATYPE(tb_same2::Enum2::Enum2Enum)
Q_DECLARE_METATYPE(tb_same2::Struct1)
Q_DECLARE_METATYPE(tb_same2::Struct2)