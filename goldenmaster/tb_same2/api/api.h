...
// Struct1 struct
// ********************************************************************
struct TB_SAME2_API_EXPORT Struct1
{
    Q_GADGET
...
// Struct2 struct
// ********************************************************************
struct TB_SAME2_API_EXPORT Struct2
{
    Q_GADGET
    Q_PROPERTY(int field1 MEMBER m_field1 )
    Q_PROPERTY(int field2 MEMBER m_field2 )
...
class TB_SAME2_API_EXPORT AbstractSameStruct1Interface : public QObject {
    Q_OBJECT
public:
...
class TB_SAME2_API_EXPORT AbstractSameStruct2Interface : public QObject {
    Q_OBJECT
public:
...
class TB_SAME2_API_EXPORT AbstractSameEnum1Interface : public QObject {
    Q_OBJECT
public:
...
class TB_SAME2_API_EXPORT AbstractSameEnum2Interface : public QObject {
    Q_OBJECT
public:
