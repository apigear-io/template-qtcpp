    ...
    , m_prop1(Struct1())
{
    ...
    SimulationClient::instance()->onNotifyState("tb.same2/SameStruct1Interface", serviceStateFunc);
    ...
    SimulationClient::instance()->doFetchState("tb.same2/SameStruct1Interface", fetchStateFunc);

    NotifyRequestFunc sig1Func = [this](NotifyRequestArg arg) { 
        emit sig1(arg.params["param1"].get<Struct1>());
    };
    SimulationClient::instance()->onNotify("tb.same2/SameStruct1Interface#sig1", sig1Func);
}
...
Struct1 SimulationSameStruct1Interface::func1(const Struct1& param1)
{
    ...
    SimulationClient::instance()->doCall("tb.same2/SameStruct1Interface", "func1", params);
    return Struct1();
}
// ********************************************************************
    ...
    , m_prop2(Struct2())
{
    ...
    SimulationClient::instance()->onNotifyState("tb.same2/SameStruct2Interface", serviceStateFunc);
    ...
    SimulationClient::instance()->doFetchState("tb.same2/SameStruct2Interface", fetchStateFunc);

    NotifyRequestFunc sig1Func = [this](NotifyRequestArg arg) { 
        emit sig1(arg.params["param1"].get<Struct1>());
    };
    SimulationClient::instance()->onNotify("tb.same2/SameStruct2Interface#sig1", sig1Func);
    ...
    SimulationClient::instance()->onNotify("tb.same2/SameStruct2Interface#sig2", sig2Func);
}
...
Struct1 SimulationSameStruct2Interface::func1(const Struct1& param1)
{
    ...
    Params params;
    params["param1"] = param1;
    SimulationClient::instance()->doCall("tb.same2/SameStruct2Interface", "func1", params);
    return Struct1();
}
...
Struct1 SimulationSameStruct2Interface::func2(const Struct1& param1, const Struct2& param2)
{
    ...
    SimulationClient::instance()->doCall("tb.same2/SameStruct2Interface", "func2", params);
    return Struct1();
}
// ********************************************************************
    ...
    , m_prop1(Enum1::value1)
{
    ...
    SimulationClient::instance()->onNotifyState("tb.same2/SameEnum1Interface", serviceStateFunc);
    ...
    SimulationClient::instance()->doFetchState("tb.same2/SameEnum1Interface", fetchStateFunc);

    NotifyRequestFunc sig1Func = [this](NotifyRequestArg arg) { 
        emit sig1(arg.params["param1"].get<Enum1::Enum1Enum>());
    };
    SimulationClient::instance()->onNotify("tb.same2/SameEnum1Interface#sig1", sig1Func);
}
...
Enum1::Enum1Enum SimulationSameEnum1Interface::func1(const Enum1::Enum1Enum param1)
{
    ...
    Params params;
    params["param1"] = param1;
    SimulationClient::instance()->doCall("tb.same2/SameEnum1Interface", "func1", params);
    return Enum1::value1;
}
// ********************************************************************
    ...
    , m_prop2(Enum2::value1)
{
    ...
    SimulationClient::instance()->onNotifyState("tb.same2/SameEnum2Interface", serviceStateFunc);
    ...
    SimulationClient::instance()->doFetchState("tb.same2/SameEnum2Interface", fetchStateFunc);

    NotifyRequestFunc sig1Func = [this](NotifyRequestArg arg) { 
        emit sig1(arg.params["param1"].get<Enum1::Enum1Enum>());
    };
    SimulationClient::instance()->onNotify("tb.same2/SameEnum2Interface#sig1", sig1Func);

    NotifyRequestFunc sig2Func = [this](NotifyRequestArg arg) { 
        emit sig2(arg.params["param1"].get<Enum1::Enum1Enum>(),arg.params["param2"].get<Enum2::Enum2Enum>());
    };
    SimulationClient::instance()->onNotify("tb.same2/SameEnum2Interface#sig2", sig2Func);
}
...
Enum1::Enum1Enum SimulationSameEnum2Interface::func1(const Enum1::Enum1Enum param1)
{
    ...
    Params params;
    params["param1"] = param1;
    SimulationClient::instance()->doCall("tb.same2/SameEnum2Interface", "func1", params);
    return Enum1::value1;
}
...
Enum1::Enum1Enum SimulationSameEnum2Interface::func2(const Enum1::Enum1Enum param1, const Enum2::Enum2Enum param2)
{
    ...
    params["param1"] = param1;
    params["param2"] = param2;
    SimulationClient::instance()->doCall("tb.same2/SameEnum2Interface", "func2", params);
    return Enum1::value1;
}
