...
#if defined(TB_SAME2_IMPL_LIBRARY)
#  define TB_SAME2_IMPL_EXPORT Q_DECL_EXPORT
#else
#  define TB_SAME2_IMPL_EXPORT Q_DECL_IMPORT
#endif
...
*/
class TB_SAME2_IMPL_EXPORT SameStruct2Interface : public AbstractSameStruct2Interface
{
    Q_OBJECT
public:
