...
class TB_SAME2_MONITOR_EXPORT SameStruct1InterfaceAgent
{
public:
...
class TB_SAME2_MONITOR_EXPORT SameStruct2InterfaceAgent
{
public:
...
class TB_SAME2_MONITOR_EXPORT SameEnum1InterfaceAgent
{
public:
...
class TB_SAME2_MONITOR_EXPORT SameEnum2InterfaceAgent
{
public:
