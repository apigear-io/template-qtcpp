...
namespace
{
const QString InterfaceName = "tb.same2/SameStruct2Interface";
}
...
QFuture<Struct1> MqttSameStruct2Interface::func1Async(const Struct1& param1)
{
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
QFuture<Struct1> MqttSameStruct2Interface::func2Async(const Struct1& param1, const Struct2& param2)
{
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void MqttSameStruct2Interface::findAndExecuteCall(const nlohmann::json& value, quint64 callId, QString topic)
{
