...
*/
class OLinkSameStruct1InterfaceAdapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkSameStruct1InterfaceAdapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractSameStruct1Interface* impl, QObject *parent = nullptr);
    virtual ~OLinkSameStruct1InterfaceAdapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a SameStruct1Interface that gets adapted to objectlink with OLinkSameStruct1InterfaceAdapter.
    */
    AbstractSameStruct1Interface* m_impl;
    /**
