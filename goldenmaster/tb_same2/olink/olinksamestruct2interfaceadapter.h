...
*/
class OLinkSameStruct2InterfaceAdapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkSameStruct2InterfaceAdapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractSameStruct2Interface* impl, QObject *parent = nullptr);
    virtual ~OLinkSameStruct2InterfaceAdapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a SameStruct2Interface that gets adapted to objectlink with OLinkSameStruct2InterfaceAdapter.
    */
    AbstractSameStruct2Interface* m_impl;
    /**
