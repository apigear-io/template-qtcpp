...
TEST_CASE("Olink  tb.same2 SameEnum1Interface tests")
{
    ...
    auto clientSameEnum1Interface = std::make_shared< tb_same2::OLinkSameEnum1Interface>();
    ...
    auto serviceSameEnum1Interface = std::make_shared< tb_same2::OLinkSameEnum1InterfaceAdapter>(remote_registry, implSameEnum1Interface.get());
