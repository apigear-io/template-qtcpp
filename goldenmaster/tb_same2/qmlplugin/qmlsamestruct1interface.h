...
*/
class TB_SAME2_QML_EXPORT QmlSameStruct1Interface : public AbstractSameStruct1Interface
{
    Q_OBJECT
    QML_NAMED_ELEMENT(TbSame2SameStruct1Interface)

    /**
    * Exposes prop1 property for qml.
    */
    Q_PROPERTY(tb_same2::Struct1 prop1 READ prop1 WRITE setProp1 NOTIFY prop1Changed)
public:
    ...
    */
    tb_same2::Struct1 prop1() const override;
    /*
    ...
    */
    void setProp1(const tb_same2::Struct1& prop1) override;
...
Q_SIGNALS:
    ...
    void prop1Changed(const tb_same2::Struct1& prop1);
private:
    /**
