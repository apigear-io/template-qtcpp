...
*/
class TB_SAME2_QML_EXPORT QmlSameStruct2Interface : public AbstractSameStruct2Interface
{
    Q_OBJECT
    QML_NAMED_ELEMENT(TbSame2SameStruct2Interface)

    /**
    * Exposes prop1 property for qml.
    */
    Q_PROPERTY(tb_same2::Struct2 prop1 READ prop1 WRITE setProp1 NOTIFY prop1Changed)

    /**
    * Exposes prop2 property for qml.
    */
    Q_PROPERTY(tb_same2::Struct2 prop2 READ prop2 WRITE setProp2 NOTIFY prop2Changed)
public:
    ...
    */
    tb_same2::Struct2 prop1() const override;
    /*
    ...
    */
    void setProp1(const tb_same2::Struct2& prop1) override;
    /**
    * Getter for a prop2 property
    * @return A value for prop2 property provided by backend.
    */
    tb_same2::Struct2 prop2() const override;
    /*
    ...
    */
    void setProp2(const tb_same2::Struct2& prop2) override;

    /**
    * Exposes func1 of backend implementation to a qml.
    *   
    */
    Q_INVOKABLE tb_same2::Struct1 func1(const tb_same2::Struct1& param1) override;

    /**
    * Exposes func2 of backend implementation to a qml.
    *   
    */
    Q_INVOKABLE tb_same2::Struct1 func2(const tb_same2::Struct1& param1, const tb_same2::Struct2& param2) override;

Q_SIGNALS:
    /** Re-define singals for property changed notification, to make them are available for qml property */
    void prop1Changed(const tb_same2::Struct2& prop1);
    void prop2Changed(const tb_same2::Struct2& prop2);
private:
    /**
