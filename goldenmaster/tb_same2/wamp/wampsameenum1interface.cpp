...
{    
    ...
    WampClient::instance()->doCall("tb.same2.SameEnum1Interface._get", json::array(), json::object(), [this](WAMP::ResponseArg arg) {
        this->applyState(arg.kwargs);
    });

    // subscribe to state changes
    WampClient::instance()->doSubscribe("tb.same2.SameEnum1Interface", [this](WAMP::EventArg arg) {
        this->applyState(arg.kwargs);
    });
    // subscribe to signal sig1
    WampClient::instance()->doSubscribe("tb.same2.SameEnum1Interface.sig1", [this](WAMP::EventArg arg) {
        this->notifySig1(arg);
    });
}
...
void WampSameEnum1Interface::setProp1(const Enum1::Enum1Enum prop1)
{
    ...
    WampClient::instance()->doCall("tb.same2.SameEnum1Interface._set", json::array(), fields);
}
...
QtPromise::QPromise<Enum1::Enum1Enum> WampSameEnum1Interface::func1Async(const Enum1::Enum1Enum param1)
{
    return QtPromise::QPromise<Enum1::Enum1Enum>{[&](
        const QtPromise::QPromiseResolve<Enum1::Enum1Enum>& resolve) {
            WampClient::instance()->doCall("tb.same2.SameEnum1Interface.func1", json::array({param1}), json::object(), [resolve](WAMP::ResponseArg arg) {                
