...
class WampSameEnum2InterfaceAdapter : public QObject
{
    Q_OBJECT
public:
    explicit WampSameEnum2InterfaceAdapter(AbstractSameEnum2Interface* impl, QObject *parent = nullptr);
    virtual ~WampSameEnum2InterfaceAdapter() override;
public:
    void publishState();
    ...
    void publishSig2(const Enum1::Enum1Enum param1, const Enum2::Enum2Enum param2);
private:
