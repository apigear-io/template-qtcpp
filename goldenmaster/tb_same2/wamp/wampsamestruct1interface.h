...
class WampSameStruct1Interface : public AbstractSameStruct1Interface
{
    Q_OBJECT
public:
    explicit WampSameStruct1Interface(QObject *parent = nullptr);
    virtual ~WampSameStruct1Interface() override;
