...
signals:
    ...
    * @param paramFloat32 
    */
    void sigFloat32(float paramFloat32);
    /**
    * @param paramFloat64 
    */
...
public:
    ...
    */
    ...
    /**
    * Sets the value of the propReadOnlyString property.
    */
    virtual void setPropReadOnlyString(const QString& propReadOnlyString) = 0;
    /**
    * Gets the value of the propReadOnlyString property.
    */
    virtual QString propReadOnlyString() const = 0;
...
signals:
    ...
    */
    ...
    /**
    * Emitted when propReadOnlyString value has changed.
    */
