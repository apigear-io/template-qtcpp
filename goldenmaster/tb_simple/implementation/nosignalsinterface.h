...
*/
class TB_SIMPLE_IMPL_EXPORT NoSignalsInterface : public AbstractNoSignalsInterface
{
    Q_OBJECT
public:
    explicit NoSignalsInterface(QObject *parent = nullptr);
    virtual ~NoSignalsInterface() override;
