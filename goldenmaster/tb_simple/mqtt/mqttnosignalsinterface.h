...
/**
* Adapts the general Mqtt Client handler to a NoSignalsInterface in a way it provides access
...
*/
class TB_SIMPLE_MQTT_LIBRARY_EXPORT MqttNoSignalsInterface : public AbstractNoSignalsInterface
{
    Q_OBJECT
public:
    /** ctor */
    explicit MqttNoSignalsInterface(ApiGear::Mqtt::Client& client, QObject *parent = nullptr);
    /** dtor */
    ~MqttNoSignalsInterface() override;
    /**
    * Property getter
...
private:
    // Helper function, subscribes for property changes from the remote NoSignalsInterface service.
    void subscribeForPropertiesChanges();
    // Helper function, subscribes for result of invoke on remote NoSignalsInterface service.
