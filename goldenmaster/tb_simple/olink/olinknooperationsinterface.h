...
/**
* Adapts the general OLink Client handler to a NoOperationsInterface in a way it provides access 
...
*     It provides a network implementation and tools to connect OLinkNoOperationsInterface to it.
...
*/
class OLinkNoOperationsInterface : public AbstractNoOperationsInterface, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkNoOperationsInterface(QObject *parent = nullptr);
    /** dtor */
    ~OLinkNoOperationsInterface() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkNoOperationsInterface is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkNoOperationsInterface.
