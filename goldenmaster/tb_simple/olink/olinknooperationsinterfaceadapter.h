...
*/
class OLinkNoOperationsInterfaceAdapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkNoOperationsInterfaceAdapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractNoOperationsInterface* impl, QObject *parent = nullptr);
    virtual ~OLinkNoOperationsInterfaceAdapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a NoOperationsInterface that gets adapted to objectlink with OLinkNoOperationsInterfaceAdapter.
    */
    AbstractNoOperationsInterface* m_impl;
    /**
