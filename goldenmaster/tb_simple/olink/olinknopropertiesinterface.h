...
/**
* Adapts the general OLink Client handler to a NoPropertiesInterface in a way it provides access 
...
*     It provides a network implementation and tools to connect OLinkNoPropertiesInterface to it.
...
*/
class OLinkNoPropertiesInterface : public AbstractNoPropertiesInterface, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkNoPropertiesInterface(QObject *parent = nullptr);
    /** dtor */
    ~OLinkNoPropertiesInterface() override = default;
    /**
...
signals:
    ...
    /**
    * Informs if the OLinkNoPropertiesInterface is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkNoPropertiesInterface.
