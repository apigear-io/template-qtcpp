...
*/
class OLinkNoPropertiesInterfaceAdapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkNoPropertiesInterfaceAdapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractNoPropertiesInterface* impl, QObject *parent = nullptr);
    virtual ~OLinkNoPropertiesInterfaceAdapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a NoPropertiesInterface that gets adapted to objectlink with OLinkNoPropertiesInterfaceAdapter.
    */
    AbstractNoPropertiesInterface* m_impl;
    /**
