...
*/
class OLinkNoSignalsInterfaceAdapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkNoSignalsInterfaceAdapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractNoSignalsInterface* impl, QObject *parent = nullptr);
    virtual ~OLinkNoSignalsInterfaceAdapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a NoSignalsInterface that gets adapted to objectlink with OLinkNoSignalsInterfaceAdapter.
    */
    AbstractNoSignalsInterface* m_impl;
    /**
