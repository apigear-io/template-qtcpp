...
*/
class OLinkSimpleArrayInterfaceAdapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkSimpleArrayInterfaceAdapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractSimpleArrayInterface* impl, QObject *parent = nullptr);
    virtual ~OLinkSimpleArrayInterfaceAdapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a SimpleArrayInterface that gets adapted to objectlink with OLinkSimpleArrayInterfaceAdapter.
    */
