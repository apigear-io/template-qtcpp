...
*/
class OLinkVoidInterfaceAdapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkVoidInterfaceAdapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractVoidInterface* impl, QObject *parent = nullptr);
    virtual ~OLinkVoidInterfaceAdapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a VoidInterface that gets adapted to objectlink with OLinkVoidInterfaceAdapter.
    */
    AbstractVoidInterface* m_impl;
    /**
