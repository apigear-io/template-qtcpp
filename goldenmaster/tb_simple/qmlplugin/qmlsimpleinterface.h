...
*/
class TB_SIMPLE_QML_EXPORT QmlSimpleInterface : public AbstractSimpleInterface
{
    Q_OBJECT
    QML_NAMED_ELEMENT(TbSimpleSimpleInterface)
...
public:
    ...
    */
    ...
    /**
    * Exposes funcNoReturnValue of backend implementation to a qml.
    *   
    */
    Q_INVOKABLE void funcNoReturnValue(bool paramBool) override;
