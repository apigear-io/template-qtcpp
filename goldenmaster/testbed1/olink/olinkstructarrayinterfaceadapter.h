...
class OLinkStructArrayInterfaceAdapter : public QObject, public IObjectSource
{
    Q_OBJECT
public:
    explicit OLinkStructArrayInterfaceAdapter(RemoteRegistry& registry, AbstractStructArrayInterface* impl, QObject *parent = nullptr);
