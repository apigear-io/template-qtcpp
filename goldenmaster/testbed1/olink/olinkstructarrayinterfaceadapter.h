...
*/
class OLinkStructArrayInterfaceAdapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkStructArrayInterfaceAdapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractStructArrayInterface* impl, QObject *parent = nullptr);
    virtual ~OLinkStructArrayInterfaceAdapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a StructArrayInterface that gets adapted to objectlink with OLinkStructArrayInterfaceAdapter.
    */
