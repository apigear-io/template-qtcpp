...
*/
class OLinkStructInterfaceAdapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkStructInterfaceAdapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractStructInterface* impl, QObject *parent = nullptr);
    virtual ~OLinkStructInterfaceAdapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a StructInterface that gets adapted to objectlink with OLinkStructInterfaceAdapter.
    */
    AbstractStructInterface* m_impl;
    /**
