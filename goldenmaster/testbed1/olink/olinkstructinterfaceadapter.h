...
class OLinkStructInterfaceAdapter : public QObject, public IObjectSource
{
    Q_OBJECT
public:
    explicit OLinkStructInterfaceAdapter(RemoteRegistry& registry, AbstractStructInterface* impl, QObject *parent = nullptr);
