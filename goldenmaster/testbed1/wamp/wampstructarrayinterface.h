...
class WampStructArrayInterface : public AbstractStructArrayInterface
{
    Q_OBJECT
public:
    explicit WampStructArrayInterface(QObject *parent = nullptr);
    virtual ~WampStructArrayInterface() override;
