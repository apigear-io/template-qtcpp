...
class HttpNestedStruct2Interface : public AbstractNestedStruct2Interface
{
    Q_OBJECT
public:
    explicit HttpNestedStruct2Interface(QNetworkAccessManager *network, QObject *parent = nullptr);
    virtual ~HttpNestedStruct2Interface() override;
