...
NestedStruct1 MqttNestedStruct1Interface::prop1() const
{
    return m_prop1;
}

NestedStruct1 MqttNestedStruct1Interface::func1(const NestedStruct1& param1)
{
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
QFuture<NestedStruct1> MqttNestedStruct1Interface::func1Async(const NestedStruct1& param1)
{
    AG_LOG_DEBUG(Q_FUNC_INFO);
...
void MqttNestedStruct1Interface::findAndExecuteCall(const nlohmann::json& value, quint64 callId, QString topic)
{
