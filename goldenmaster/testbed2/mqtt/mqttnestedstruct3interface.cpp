...
bool MqttNestedStruct3Interface::isReady() const
{
...
void MqttNestedStruct3Interface::handleOnSubscribed(QString topic, quint64 id,  bool hasSucceed)
{
    if (!hasSucceed)
    {
...
void MqttNestedStruct3Interface::subscribeForSignals()
{
        ...
        m_subscribedIds.push_back(m_client.subscribeTopic(topicsig3,
            ...
            [this](const nlohmann::json& argumentsArray){ emit sig3(argumentsArray[0].get<NestedStruct1>(), argumentsArray[1].get<NestedStruct2>(), argumentsArray[2].get<NestedStruct3>());}));
}
