...
*/
class OLinkManyParamInterfaceAdapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkManyParamInterfaceAdapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractManyParamInterface* impl, QObject *parent = nullptr);
    virtual ~OLinkManyParamInterfaceAdapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a ManyParamInterface that gets adapted to objectlink with OLinkManyParamInterfaceAdapter.
    */
