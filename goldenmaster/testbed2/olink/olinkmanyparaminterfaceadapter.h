...
class OLinkManyParamInterfaceAdapter : public QObject, public IObjectSource
{
    Q_OBJECT
public:
    explicit OLinkManyParamInterfaceAdapter(RemoteRegistry& registry, AbstractManyParamInterface* impl, QObject *parent = nullptr);
