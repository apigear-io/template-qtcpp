...
class OLinkNestedStruct1InterfaceAdapter : public QObject, public IObjectSource
{
    Q_OBJECT
public:
    explicit OLinkNestedStruct1InterfaceAdapter(RemoteRegistry& registry, AbstractNestedStruct1Interface* impl, QObject *parent = nullptr);
