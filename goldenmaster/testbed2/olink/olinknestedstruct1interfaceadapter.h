...
*/
class OLinkNestedStruct1InterfaceAdapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkNestedStruct1InterfaceAdapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractNestedStruct1Interface* impl, QObject *parent = nullptr);
    virtual ~OLinkNestedStruct1InterfaceAdapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a NestedStruct1Interface that gets adapted to objectlink with OLinkNestedStruct1InterfaceAdapter.
    */
