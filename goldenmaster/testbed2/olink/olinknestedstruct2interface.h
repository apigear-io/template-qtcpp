...
/**
* Adapts the general OLink Client handler to a NestedStruct2Interface in a way it provides access 
...
*     It provides a network implementation and tools to connect OLinkNestedStruct2Interface to it.
...
public:
    ...
    /** dtor */
    ~OLinkNestedStruct2Interface() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkNestedStruct2Interface is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkNestedStruct2Interface.
