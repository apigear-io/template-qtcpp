...
*/
class OLinkNestedStruct2InterfaceAdapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkNestedStruct2InterfaceAdapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractNestedStruct2Interface* impl, QObject *parent = nullptr);
    virtual ~OLinkNestedStruct2InterfaceAdapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a NestedStruct2Interface that gets adapted to objectlink with OLinkNestedStruct2InterfaceAdapter.
    */
