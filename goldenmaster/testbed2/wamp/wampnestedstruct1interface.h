...
class WampNestedStruct1Interface : public AbstractNestedStruct1Interface
{
    Q_OBJECT
public:
    explicit WampNestedStruct1Interface(QObject *parent = nullptr);
    virtual ~WampNestedStruct1Interface() override;
