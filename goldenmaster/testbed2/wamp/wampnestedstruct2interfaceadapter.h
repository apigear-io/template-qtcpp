...
class WampNestedStruct2InterfaceAdapter : public QObject
{
    Q_OBJECT
public:
    explicit WampNestedStruct2InterfaceAdapter(AbstractNestedStruct2Interface* impl, QObject *parent = nullptr);
    virtual ~WampNestedStruct2InterfaceAdapter() override;
public:
    void publishState();
