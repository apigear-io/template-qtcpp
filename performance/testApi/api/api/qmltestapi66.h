...
/**
* A QML wrapper of the TestApi66 implementation.
* Uses a TestApi66 backend provided by an ApiFactory.
* Use this class to easily bind to properties and signals provided by TestApi66 backend or
* invoke operations on it. Have in mind that singals provided by TestApi66 backend should be
* emitted only by TestApi66 backend, emitting it on qml will not reach the TestApi66 backend.
* See ApiFactory and factories that implement the IApiFactory for other features.
*/
class API_API_EXPORT QmlTestApi66 : public AbstractTestApi66
{
    Q_OBJECT
...
public:
    explicit QmlTestApi66(QObject *parent = nullptr);
    ~QmlTestApi66() override;
    /**
...
private:
    /**
    * Backend of AbstractTestApi66 type that provides properties on which methods will be invoked.
    * Produced by a ApiFactory factory. 
    */
	std::shared_ptr<AbstractTestApi66> m_obj;
};
