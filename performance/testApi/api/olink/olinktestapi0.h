...
/**
* Adapts the general OLink Client handler to a TestApi0 in a way it provides access 
* to remote specific for TestApi0 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi0 to it.
* Use on client side to request changes of the TestApi0 on the server side 
* and to subscribe for the TestApi0 changes.
*/
class OLinkTestApi0 : public AbstractTestApi0, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi0(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi0() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi0 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi0.
