...
*/
class OLinkTestApi0Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi0Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi0* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi0Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi0 that gets adapted to objectlink with OLinkTestApi0Adapter.
    */
    AbstractTestApi0* m_impl;
    /**
