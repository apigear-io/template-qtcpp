...
/**
* Adapts the general OLink Client handler to a TestApi1 in a way it provides access 
* to remote specific for TestApi1 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi1 to it.
* Use on client side to request changes of the TestApi1 on the server side 
* and to subscribe for the TestApi1 changes.
*/
class OLinkTestApi1 : public AbstractTestApi1, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi1(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi1() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi1 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi1.
