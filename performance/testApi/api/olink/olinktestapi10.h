...
/**
* Adapts the general OLink Client handler to a TestApi10 in a way it provides access 
* to remote specific for TestApi10 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi10 to it.
* Use on client side to request changes of the TestApi10 on the server side 
* and to subscribe for the TestApi10 changes.
*/
class OLinkTestApi10 : public AbstractTestApi10, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi10(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi10() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi10 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi10.
