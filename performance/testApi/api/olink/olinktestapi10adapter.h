...
*/
class OLinkTestApi10Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi10Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi10* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi10Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi10 that gets adapted to objectlink with OLinkTestApi10Adapter.
    */
    AbstractTestApi10* m_impl;
    /**
