...
/**
* Adapts the general OLink Client handler to a TestApi11 in a way it provides access 
* to remote specific for TestApi11 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi11 to it.
* Use on client side to request changes of the TestApi11 on the server side 
* and to subscribe for the TestApi11 changes.
*/
class OLinkTestApi11 : public AbstractTestApi11, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi11(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi11() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi11 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi11.
