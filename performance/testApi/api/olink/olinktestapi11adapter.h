...
*/
class OLinkTestApi11Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi11Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi11* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi11Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi11 that gets adapted to objectlink with OLinkTestApi11Adapter.
    */
    AbstractTestApi11* m_impl;
    /**
