...
/**
* Adapts the general OLink Client handler to a TestApi12 in a way it provides access 
* to remote specific for TestApi12 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi12 to it.
* Use on client side to request changes of the TestApi12 on the server side 
* and to subscribe for the TestApi12 changes.
*/
class OLinkTestApi12 : public AbstractTestApi12, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi12(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi12() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi12 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi12.
