...
*/
class OLinkTestApi12Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi12Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi12* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi12Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi12 that gets adapted to objectlink with OLinkTestApi12Adapter.
    */
    AbstractTestApi12* m_impl;
    /**
