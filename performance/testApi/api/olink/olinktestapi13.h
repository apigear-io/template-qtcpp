...
/**
* Adapts the general OLink Client handler to a TestApi13 in a way it provides access 
* to remote specific for TestApi13 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi13 to it.
* Use on client side to request changes of the TestApi13 on the server side 
* and to subscribe for the TestApi13 changes.
*/
class OLinkTestApi13 : public AbstractTestApi13, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi13(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi13() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi13 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi13.
