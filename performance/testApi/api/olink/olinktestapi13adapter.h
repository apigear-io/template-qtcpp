...
*/
class OLinkTestApi13Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi13Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi13* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi13Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi13 that gets adapted to objectlink with OLinkTestApi13Adapter.
    */
    AbstractTestApi13* m_impl;
    /**
