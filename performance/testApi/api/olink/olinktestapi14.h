...
/**
* Adapts the general OLink Client handler to a TestApi14 in a way it provides access 
* to remote specific for TestApi14 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi14 to it.
* Use on client side to request changes of the TestApi14 on the server side 
* and to subscribe for the TestApi14 changes.
*/
class OLinkTestApi14 : public AbstractTestApi14, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi14(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi14() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi14 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi14.
