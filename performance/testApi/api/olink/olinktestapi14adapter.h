...
*/
class OLinkTestApi14Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi14Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi14* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi14Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi14 that gets adapted to objectlink with OLinkTestApi14Adapter.
    */
    AbstractTestApi14* m_impl;
    /**
