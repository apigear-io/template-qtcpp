...
/**
* Adapts the general OLink Client handler to a TestApi15 in a way it provides access 
* to remote specific for TestApi15 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi15 to it.
* Use on client side to request changes of the TestApi15 on the server side 
* and to subscribe for the TestApi15 changes.
*/
class OLinkTestApi15 : public AbstractTestApi15, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi15(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi15() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi15 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi15.
