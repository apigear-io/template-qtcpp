...
*/
class OLinkTestApi15Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi15Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi15* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi15Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi15 that gets adapted to objectlink with OLinkTestApi15Adapter.
    */
    AbstractTestApi15* m_impl;
    /**
