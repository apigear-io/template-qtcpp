...
/**
* Adapts the general OLink Client handler to a TestApi16 in a way it provides access 
* to remote specific for TestApi16 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi16 to it.
* Use on client side to request changes of the TestApi16 on the server side 
* and to subscribe for the TestApi16 changes.
*/
class OLinkTestApi16 : public AbstractTestApi16, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi16(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi16() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi16 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi16.
