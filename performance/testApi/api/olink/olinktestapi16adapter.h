...
*/
class OLinkTestApi16Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi16Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi16* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi16Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi16 that gets adapted to objectlink with OLinkTestApi16Adapter.
    */
    AbstractTestApi16* m_impl;
    /**
