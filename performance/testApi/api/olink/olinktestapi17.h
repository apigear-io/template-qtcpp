...
/**
* Adapts the general OLink Client handler to a TestApi17 in a way it provides access 
* to remote specific for TestApi17 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi17 to it.
* Use on client side to request changes of the TestApi17 on the server side 
* and to subscribe for the TestApi17 changes.
*/
class OLinkTestApi17 : public AbstractTestApi17, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi17(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi17() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi17 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi17.
