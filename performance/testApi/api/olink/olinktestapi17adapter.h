...
*/
class OLinkTestApi17Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi17Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi17* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi17Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi17 that gets adapted to objectlink with OLinkTestApi17Adapter.
    */
    AbstractTestApi17* m_impl;
    /**
