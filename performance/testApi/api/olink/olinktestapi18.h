...
/**
* Adapts the general OLink Client handler to a TestApi18 in a way it provides access 
* to remote specific for TestApi18 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi18 to it.
* Use on client side to request changes of the TestApi18 on the server side 
* and to subscribe for the TestApi18 changes.
*/
class OLinkTestApi18 : public AbstractTestApi18, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi18(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi18() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi18 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi18.
