...
*/
class OLinkTestApi18Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi18Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi18* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi18Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi18 that gets adapted to objectlink with OLinkTestApi18Adapter.
    */
    AbstractTestApi18* m_impl;
    /**
