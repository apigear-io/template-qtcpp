...
/**
* Adapts the general OLink Client handler to a TestApi19 in a way it provides access 
* to remote specific for TestApi19 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi19 to it.
* Use on client side to request changes of the TestApi19 on the server side 
* and to subscribe for the TestApi19 changes.
*/
class OLinkTestApi19 : public AbstractTestApi19, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi19(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi19() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi19 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi19.
