...
*/
class OLinkTestApi19Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi19Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi19* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi19Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi19 that gets adapted to objectlink with OLinkTestApi19Adapter.
    */
    AbstractTestApi19* m_impl;
    /**
