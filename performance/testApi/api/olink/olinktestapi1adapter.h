...
*/
class OLinkTestApi1Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi1Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi1* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi1Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi1 that gets adapted to objectlink with OLinkTestApi1Adapter.
    */
    AbstractTestApi1* m_impl;
    /**
