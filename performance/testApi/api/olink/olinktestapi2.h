...
/**
* Adapts the general OLink Client handler to a TestApi2 in a way it provides access 
* to remote specific for TestApi2 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi2 to it.
* Use on client side to request changes of the TestApi2 on the server side 
* and to subscribe for the TestApi2 changes.
*/
class OLinkTestApi2 : public AbstractTestApi2, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi2(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi2() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi2 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi2.
