...
/**
* Adapts the general OLink Client handler to a TestApi20 in a way it provides access 
* to remote specific for TestApi20 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi20 to it.
* Use on client side to request changes of the TestApi20 on the server side 
* and to subscribe for the TestApi20 changes.
*/
class OLinkTestApi20 : public AbstractTestApi20, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi20(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi20() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi20 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi20.
