...
*/
class OLinkTestApi20Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi20Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi20* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi20Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi20 that gets adapted to objectlink with OLinkTestApi20Adapter.
    */
    AbstractTestApi20* m_impl;
    /**
