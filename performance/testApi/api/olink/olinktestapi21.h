...
/**
* Adapts the general OLink Client handler to a TestApi21 in a way it provides access 
* to remote specific for TestApi21 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi21 to it.
* Use on client side to request changes of the TestApi21 on the server side 
* and to subscribe for the TestApi21 changes.
*/
class OLinkTestApi21 : public AbstractTestApi21, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi21(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi21() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi21 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi21.
