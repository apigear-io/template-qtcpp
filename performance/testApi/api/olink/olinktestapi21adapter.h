...
*/
class OLinkTestApi21Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi21Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi21* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi21Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi21 that gets adapted to objectlink with OLinkTestApi21Adapter.
    */
    AbstractTestApi21* m_impl;
    /**
