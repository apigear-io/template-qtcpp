...
/**
* Adapts the general OLink Client handler to a TestApi22 in a way it provides access 
* to remote specific for TestApi22 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi22 to it.
* Use on client side to request changes of the TestApi22 on the server side 
* and to subscribe for the TestApi22 changes.
*/
class OLinkTestApi22 : public AbstractTestApi22, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi22(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi22() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi22 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi22.
