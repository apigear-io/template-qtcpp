...
*/
class OLinkTestApi22Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi22Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi22* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi22Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi22 that gets adapted to objectlink with OLinkTestApi22Adapter.
    */
    AbstractTestApi22* m_impl;
    /**
