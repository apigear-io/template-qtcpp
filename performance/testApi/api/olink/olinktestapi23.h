...
/**
* Adapts the general OLink Client handler to a TestApi23 in a way it provides access 
* to remote specific for TestApi23 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi23 to it.
* Use on client side to request changes of the TestApi23 on the server side 
* and to subscribe for the TestApi23 changes.
*/
class OLinkTestApi23 : public AbstractTestApi23, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi23(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi23() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi23 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi23.
