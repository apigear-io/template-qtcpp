...
*/
class OLinkTestApi23Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi23Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi23* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi23Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi23 that gets adapted to objectlink with OLinkTestApi23Adapter.
    */
    AbstractTestApi23* m_impl;
    /**
