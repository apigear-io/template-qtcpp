...
/**
* Adapts the general OLink Client handler to a TestApi24 in a way it provides access 
* to remote specific for TestApi24 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi24 to it.
* Use on client side to request changes of the TestApi24 on the server side 
* and to subscribe for the TestApi24 changes.
*/
class OLinkTestApi24 : public AbstractTestApi24, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi24(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi24() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi24 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi24.
