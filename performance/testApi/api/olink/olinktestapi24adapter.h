...
*/
class OLinkTestApi24Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi24Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi24* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi24Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi24 that gets adapted to objectlink with OLinkTestApi24Adapter.
    */
    AbstractTestApi24* m_impl;
    /**
