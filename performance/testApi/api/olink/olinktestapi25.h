...
/**
* Adapts the general OLink Client handler to a TestApi25 in a way it provides access 
* to remote specific for TestApi25 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi25 to it.
* Use on client side to request changes of the TestApi25 on the server side 
* and to subscribe for the TestApi25 changes.
*/
class OLinkTestApi25 : public AbstractTestApi25, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi25(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi25() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi25 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi25.
