...
*/
class OLinkTestApi25Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi25Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi25* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi25Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi25 that gets adapted to objectlink with OLinkTestApi25Adapter.
    */
    AbstractTestApi25* m_impl;
    /**
