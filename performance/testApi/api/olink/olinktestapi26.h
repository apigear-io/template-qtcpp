...
/**
* Adapts the general OLink Client handler to a TestApi26 in a way it provides access 
* to remote specific for TestApi26 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi26 to it.
* Use on client side to request changes of the TestApi26 on the server side 
* and to subscribe for the TestApi26 changes.
*/
class OLinkTestApi26 : public AbstractTestApi26, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi26(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi26() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi26 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi26.
