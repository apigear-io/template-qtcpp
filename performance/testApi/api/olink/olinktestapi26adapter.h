...
*/
class OLinkTestApi26Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi26Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi26* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi26Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi26 that gets adapted to objectlink with OLinkTestApi26Adapter.
    */
    AbstractTestApi26* m_impl;
    /**
