...
/**
* Adapts the general OLink Client handler to a TestApi27 in a way it provides access 
* to remote specific for TestApi27 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi27 to it.
* Use on client side to request changes of the TestApi27 on the server side 
* and to subscribe for the TestApi27 changes.
*/
class OLinkTestApi27 : public AbstractTestApi27, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi27(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi27() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi27 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi27.
