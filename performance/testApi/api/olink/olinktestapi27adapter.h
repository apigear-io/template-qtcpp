...
*/
class OLinkTestApi27Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi27Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi27* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi27Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi27 that gets adapted to objectlink with OLinkTestApi27Adapter.
    */
    AbstractTestApi27* m_impl;
    /**
