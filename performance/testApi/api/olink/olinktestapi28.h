...
/**
* Adapts the general OLink Client handler to a TestApi28 in a way it provides access 
* to remote specific for TestApi28 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi28 to it.
* Use on client side to request changes of the TestApi28 on the server side 
* and to subscribe for the TestApi28 changes.
*/
class OLinkTestApi28 : public AbstractTestApi28, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi28(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi28() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi28 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi28.
