...
*/
class OLinkTestApi28Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi28Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi28* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi28Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi28 that gets adapted to objectlink with OLinkTestApi28Adapter.
    */
    AbstractTestApi28* m_impl;
    /**
