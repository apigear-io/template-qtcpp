...
/**
* Adapts the general OLink Client handler to a TestApi29 in a way it provides access 
* to remote specific for TestApi29 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi29 to it.
* Use on client side to request changes of the TestApi29 on the server side 
* and to subscribe for the TestApi29 changes.
*/
class OLinkTestApi29 : public AbstractTestApi29, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi29(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi29() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi29 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi29.
