...
*/
class OLinkTestApi29Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi29Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi29* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi29Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi29 that gets adapted to objectlink with OLinkTestApi29Adapter.
    */
    AbstractTestApi29* m_impl;
    /**
