...
*/
class OLinkTestApi2Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi2Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi2* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi2Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi2 that gets adapted to objectlink with OLinkTestApi2Adapter.
    */
    AbstractTestApi2* m_impl;
    /**
