...
/**
* Adapts the general OLink Client handler to a TestApi3 in a way it provides access 
* to remote specific for TestApi3 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi3 to it.
* Use on client side to request changes of the TestApi3 on the server side 
* and to subscribe for the TestApi3 changes.
*/
class OLinkTestApi3 : public AbstractTestApi3, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi3(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi3() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi3 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi3.
