...
/**
* Adapts the general OLink Client handler to a TestApi30 in a way it provides access 
* to remote specific for TestApi30 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi30 to it.
* Use on client side to request changes of the TestApi30 on the server side 
* and to subscribe for the TestApi30 changes.
*/
class OLinkTestApi30 : public AbstractTestApi30, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi30(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi30() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi30 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi30.
