...
*/
class OLinkTestApi30Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi30Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi30* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi30Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi30 that gets adapted to objectlink with OLinkTestApi30Adapter.
    */
    AbstractTestApi30* m_impl;
    /**
