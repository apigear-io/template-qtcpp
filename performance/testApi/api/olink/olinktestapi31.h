...
/**
* Adapts the general OLink Client handler to a TestApi31 in a way it provides access 
* to remote specific for TestApi31 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi31 to it.
* Use on client side to request changes of the TestApi31 on the server side 
* and to subscribe for the TestApi31 changes.
*/
class OLinkTestApi31 : public AbstractTestApi31, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi31(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi31() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi31 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi31.
