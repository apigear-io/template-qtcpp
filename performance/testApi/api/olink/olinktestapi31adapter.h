...
*/
class OLinkTestApi31Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi31Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi31* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi31Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi31 that gets adapted to objectlink with OLinkTestApi31Adapter.
    */
    AbstractTestApi31* m_impl;
    /**
