...
/**
* Adapts the general OLink Client handler to a TestApi32 in a way it provides access 
* to remote specific for TestApi32 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi32 to it.
* Use on client side to request changes of the TestApi32 on the server side 
* and to subscribe for the TestApi32 changes.
*/
class OLinkTestApi32 : public AbstractTestApi32, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi32(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi32() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi32 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi32.
