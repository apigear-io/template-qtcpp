...
*/
class OLinkTestApi32Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi32Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi32* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi32Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi32 that gets adapted to objectlink with OLinkTestApi32Adapter.
    */
    AbstractTestApi32* m_impl;
    /**
