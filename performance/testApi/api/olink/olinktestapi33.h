...
/**
* Adapts the general OLink Client handler to a TestApi33 in a way it provides access 
* to remote specific for TestApi33 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi33 to it.
* Use on client side to request changes of the TestApi33 on the server side 
* and to subscribe for the TestApi33 changes.
*/
class OLinkTestApi33 : public AbstractTestApi33, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi33(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi33() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi33 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi33.
