...
*/
class OLinkTestApi33Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi33Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi33* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi33Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi33 that gets adapted to objectlink with OLinkTestApi33Adapter.
    */
    AbstractTestApi33* m_impl;
    /**
