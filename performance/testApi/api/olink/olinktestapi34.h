...
/**
* Adapts the general OLink Client handler to a TestApi34 in a way it provides access 
* to remote specific for TestApi34 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi34 to it.
* Use on client side to request changes of the TestApi34 on the server side 
* and to subscribe for the TestApi34 changes.
*/
class OLinkTestApi34 : public AbstractTestApi34, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi34(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi34() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi34 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi34.
