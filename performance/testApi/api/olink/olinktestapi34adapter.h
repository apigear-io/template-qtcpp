...
*/
class OLinkTestApi34Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi34Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi34* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi34Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi34 that gets adapted to objectlink with OLinkTestApi34Adapter.
    */
    AbstractTestApi34* m_impl;
    /**
