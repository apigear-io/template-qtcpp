...
/**
* Adapts the general OLink Client handler to a TestApi35 in a way it provides access 
* to remote specific for TestApi35 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi35 to it.
* Use on client side to request changes of the TestApi35 on the server side 
* and to subscribe for the TestApi35 changes.
*/
class OLinkTestApi35 : public AbstractTestApi35, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi35(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi35() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi35 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi35.
