...
*/
class OLinkTestApi35Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi35Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi35* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi35Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi35 that gets adapted to objectlink with OLinkTestApi35Adapter.
    */
    AbstractTestApi35* m_impl;
    /**
