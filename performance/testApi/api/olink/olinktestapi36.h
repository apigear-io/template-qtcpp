...
/**
* Adapts the general OLink Client handler to a TestApi36 in a way it provides access 
* to remote specific for TestApi36 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi36 to it.
* Use on client side to request changes of the TestApi36 on the server side 
* and to subscribe for the TestApi36 changes.
*/
class OLinkTestApi36 : public AbstractTestApi36, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi36(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi36() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi36 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi36.
