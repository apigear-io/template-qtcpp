...
*/
class OLinkTestApi36Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi36Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi36* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi36Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi36 that gets adapted to objectlink with OLinkTestApi36Adapter.
    */
    AbstractTestApi36* m_impl;
    /**
