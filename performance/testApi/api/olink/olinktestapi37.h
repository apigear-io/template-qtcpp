...
/**
* Adapts the general OLink Client handler to a TestApi37 in a way it provides access 
* to remote specific for TestApi37 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi37 to it.
* Use on client side to request changes of the TestApi37 on the server side 
* and to subscribe for the TestApi37 changes.
*/
class OLinkTestApi37 : public AbstractTestApi37, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi37(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi37() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi37 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi37.
