...
*/
class OLinkTestApi37Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi37Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi37* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi37Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi37 that gets adapted to objectlink with OLinkTestApi37Adapter.
    */
    AbstractTestApi37* m_impl;
    /**
