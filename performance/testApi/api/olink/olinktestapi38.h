...
/**
* Adapts the general OLink Client handler to a TestApi38 in a way it provides access 
* to remote specific for TestApi38 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi38 to it.
* Use on client side to request changes of the TestApi38 on the server side 
* and to subscribe for the TestApi38 changes.
*/
class OLinkTestApi38 : public AbstractTestApi38, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi38(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi38() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi38 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi38.
