...
*/
class OLinkTestApi38Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi38Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi38* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi38Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi38 that gets adapted to objectlink with OLinkTestApi38Adapter.
    */
    AbstractTestApi38* m_impl;
    /**
