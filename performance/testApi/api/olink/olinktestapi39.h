...
/**
* Adapts the general OLink Client handler to a TestApi39 in a way it provides access 
* to remote specific for TestApi39 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi39 to it.
* Use on client side to request changes of the TestApi39 on the server side 
* and to subscribe for the TestApi39 changes.
*/
class OLinkTestApi39 : public AbstractTestApi39, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi39(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi39() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi39 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi39.
