...
*/
class OLinkTestApi39Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi39Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi39* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi39Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi39 that gets adapted to objectlink with OLinkTestApi39Adapter.
    */
    AbstractTestApi39* m_impl;
    /**
