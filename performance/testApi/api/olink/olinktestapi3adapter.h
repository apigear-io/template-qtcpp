...
*/
class OLinkTestApi3Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi3Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi3* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi3Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi3 that gets adapted to objectlink with OLinkTestApi3Adapter.
    */
    AbstractTestApi3* m_impl;
    /**
