...
/**
* Adapts the general OLink Client handler to a TestApi4 in a way it provides access 
* to remote specific for TestApi4 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi4 to it.
* Use on client side to request changes of the TestApi4 on the server side 
* and to subscribe for the TestApi4 changes.
*/
class OLinkTestApi4 : public AbstractTestApi4, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi4(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi4() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi4 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi4.
