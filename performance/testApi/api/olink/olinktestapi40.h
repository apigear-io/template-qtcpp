...
/**
* Adapts the general OLink Client handler to a TestApi40 in a way it provides access 
* to remote specific for TestApi40 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi40 to it.
* Use on client side to request changes of the TestApi40 on the server side 
* and to subscribe for the TestApi40 changes.
*/
class OLinkTestApi40 : public AbstractTestApi40, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi40(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi40() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi40 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi40.
