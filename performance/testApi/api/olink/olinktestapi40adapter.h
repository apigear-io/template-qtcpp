...
*/
class OLinkTestApi40Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi40Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi40* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi40Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi40 that gets adapted to objectlink with OLinkTestApi40Adapter.
    */
    AbstractTestApi40* m_impl;
    /**
