...
/**
* Adapts the general OLink Client handler to a TestApi41 in a way it provides access 
* to remote specific for TestApi41 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi41 to it.
* Use on client side to request changes of the TestApi41 on the server side 
* and to subscribe for the TestApi41 changes.
*/
class OLinkTestApi41 : public AbstractTestApi41, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi41(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi41() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi41 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi41.
