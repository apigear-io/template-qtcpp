...
*/
class OLinkTestApi41Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi41Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi41* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi41Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi41 that gets adapted to objectlink with OLinkTestApi41Adapter.
    */
    AbstractTestApi41* m_impl;
    /**
