...
/**
* Adapts the general OLink Client handler to a TestApi42 in a way it provides access 
* to remote specific for TestApi42 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi42 to it.
* Use on client side to request changes of the TestApi42 on the server side 
* and to subscribe for the TestApi42 changes.
*/
class OLinkTestApi42 : public AbstractTestApi42, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi42(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi42() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi42 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi42.
