...
*/
class OLinkTestApi42Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi42Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi42* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi42Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi42 that gets adapted to objectlink with OLinkTestApi42Adapter.
    */
    AbstractTestApi42* m_impl;
    /**
