...
/**
* Adapts the general OLink Client handler to a TestApi43 in a way it provides access 
* to remote specific for TestApi43 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi43 to it.
* Use on client side to request changes of the TestApi43 on the server side 
* and to subscribe for the TestApi43 changes.
*/
class OLinkTestApi43 : public AbstractTestApi43, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi43(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi43() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi43 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi43.
