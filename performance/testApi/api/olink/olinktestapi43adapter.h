...
*/
class OLinkTestApi43Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi43Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi43* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi43Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi43 that gets adapted to objectlink with OLinkTestApi43Adapter.
    */
    AbstractTestApi43* m_impl;
    /**
