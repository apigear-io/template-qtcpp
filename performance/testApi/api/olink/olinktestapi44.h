...
/**
* Adapts the general OLink Client handler to a TestApi44 in a way it provides access 
* to remote specific for TestApi44 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi44 to it.
* Use on client side to request changes of the TestApi44 on the server side 
* and to subscribe for the TestApi44 changes.
*/
class OLinkTestApi44 : public AbstractTestApi44, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi44(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi44() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi44 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi44.
