...
*/
class OLinkTestApi44Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi44Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi44* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi44Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi44 that gets adapted to objectlink with OLinkTestApi44Adapter.
    */
    AbstractTestApi44* m_impl;
    /**
