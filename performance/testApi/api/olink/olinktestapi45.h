...
/**
* Adapts the general OLink Client handler to a TestApi45 in a way it provides access 
* to remote specific for TestApi45 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi45 to it.
* Use on client side to request changes of the TestApi45 on the server side 
* and to subscribe for the TestApi45 changes.
*/
class OLinkTestApi45 : public AbstractTestApi45, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi45(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi45() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi45 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi45.
