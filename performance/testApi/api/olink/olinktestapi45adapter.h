...
*/
class OLinkTestApi45Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi45Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi45* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi45Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi45 that gets adapted to objectlink with OLinkTestApi45Adapter.
    */
    AbstractTestApi45* m_impl;
    /**
