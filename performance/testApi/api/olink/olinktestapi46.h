...
/**
* Adapts the general OLink Client handler to a TestApi46 in a way it provides access 
* to remote specific for TestApi46 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi46 to it.
* Use on client side to request changes of the TestApi46 on the server side 
* and to subscribe for the TestApi46 changes.
*/
class OLinkTestApi46 : public AbstractTestApi46, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi46(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi46() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi46 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi46.
