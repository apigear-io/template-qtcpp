...
*/
class OLinkTestApi46Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi46Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi46* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi46Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi46 that gets adapted to objectlink with OLinkTestApi46Adapter.
    */
    AbstractTestApi46* m_impl;
    /**
