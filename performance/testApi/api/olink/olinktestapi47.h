...
/**
* Adapts the general OLink Client handler to a TestApi47 in a way it provides access 
* to remote specific for TestApi47 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi47 to it.
* Use on client side to request changes of the TestApi47 on the server side 
* and to subscribe for the TestApi47 changes.
*/
class OLinkTestApi47 : public AbstractTestApi47, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi47(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi47() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi47 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi47.
