...
*/
class OLinkTestApi47Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi47Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi47* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi47Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi47 that gets adapted to objectlink with OLinkTestApi47Adapter.
    */
    AbstractTestApi47* m_impl;
    /**
