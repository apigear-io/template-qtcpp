...
/**
* Adapts the general OLink Client handler to a TestApi48 in a way it provides access 
* to remote specific for TestApi48 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi48 to it.
* Use on client side to request changes of the TestApi48 on the server side 
* and to subscribe for the TestApi48 changes.
*/
class OLinkTestApi48 : public AbstractTestApi48, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi48(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi48() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi48 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi48.
