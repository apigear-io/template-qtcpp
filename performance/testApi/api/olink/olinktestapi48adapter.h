...
*/
class OLinkTestApi48Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi48Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi48* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi48Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi48 that gets adapted to objectlink with OLinkTestApi48Adapter.
    */
    AbstractTestApi48* m_impl;
    /**
