...
/**
* Adapts the general OLink Client handler to a TestApi49 in a way it provides access 
* to remote specific for TestApi49 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi49 to it.
* Use on client side to request changes of the TestApi49 on the server side 
* and to subscribe for the TestApi49 changes.
*/
class OLinkTestApi49 : public AbstractTestApi49, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi49(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi49() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi49 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi49.
