...
*/
class OLinkTestApi49Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi49Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi49* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi49Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi49 that gets adapted to objectlink with OLinkTestApi49Adapter.
    */
    AbstractTestApi49* m_impl;
    /**
