...
*/
class OLinkTestApi4Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi4Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi4* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi4Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi4 that gets adapted to objectlink with OLinkTestApi4Adapter.
    */
    AbstractTestApi4* m_impl;
    /**
