...
/**
* Adapts the general OLink Client handler to a TestApi5 in a way it provides access 
* to remote specific for TestApi5 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi5 to it.
* Use on client side to request changes of the TestApi5 on the server side 
* and to subscribe for the TestApi5 changes.
*/
class OLinkTestApi5 : public AbstractTestApi5, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi5(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi5() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi5 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi5.
