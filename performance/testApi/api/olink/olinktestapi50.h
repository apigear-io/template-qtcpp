...
/**
* Adapts the general OLink Client handler to a TestApi50 in a way it provides access 
* to remote specific for TestApi50 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi50 to it.
* Use on client side to request changes of the TestApi50 on the server side 
* and to subscribe for the TestApi50 changes.
*/
class OLinkTestApi50 : public AbstractTestApi50, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi50(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi50() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi50 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi50.
