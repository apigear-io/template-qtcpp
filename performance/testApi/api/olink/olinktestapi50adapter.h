...
*/
class OLinkTestApi50Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi50Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi50* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi50Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi50 that gets adapted to objectlink with OLinkTestApi50Adapter.
    */
    AbstractTestApi50* m_impl;
    /**
