...
/**
* Adapts the general OLink Client handler to a TestApi51 in a way it provides access 
* to remote specific for TestApi51 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi51 to it.
* Use on client side to request changes of the TestApi51 on the server side 
* and to subscribe for the TestApi51 changes.
*/
class OLinkTestApi51 : public AbstractTestApi51, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi51(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi51() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi51 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi51.
