...
*/
class OLinkTestApi51Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi51Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi51* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi51Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi51 that gets adapted to objectlink with OLinkTestApi51Adapter.
    */
    AbstractTestApi51* m_impl;
    /**
