...
/**
* Adapts the general OLink Client handler to a TestApi52 in a way it provides access 
* to remote specific for TestApi52 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi52 to it.
* Use on client side to request changes of the TestApi52 on the server side 
* and to subscribe for the TestApi52 changes.
*/
class OLinkTestApi52 : public AbstractTestApi52, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi52(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi52() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi52 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi52.
