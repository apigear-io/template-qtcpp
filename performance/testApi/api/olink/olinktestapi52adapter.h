...
*/
class OLinkTestApi52Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi52Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi52* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi52Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi52 that gets adapted to objectlink with OLinkTestApi52Adapter.
    */
    AbstractTestApi52* m_impl;
    /**
