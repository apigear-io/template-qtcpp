...
/**
* Adapts the general OLink Client handler to a TestApi53 in a way it provides access 
* to remote specific for TestApi53 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi53 to it.
* Use on client side to request changes of the TestApi53 on the server side 
* and to subscribe for the TestApi53 changes.
*/
class OLinkTestApi53 : public AbstractTestApi53, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi53(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi53() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi53 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi53.
