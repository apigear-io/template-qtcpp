...
*/
class OLinkTestApi53Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi53Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi53* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi53Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi53 that gets adapted to objectlink with OLinkTestApi53Adapter.
    */
    AbstractTestApi53* m_impl;
    /**
