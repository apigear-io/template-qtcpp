...
/**
* Adapts the general OLink Client handler to a TestApi54 in a way it provides access 
* to remote specific for TestApi54 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi54 to it.
* Use on client side to request changes of the TestApi54 on the server side 
* and to subscribe for the TestApi54 changes.
*/
class OLinkTestApi54 : public AbstractTestApi54, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi54(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi54() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi54 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi54.
