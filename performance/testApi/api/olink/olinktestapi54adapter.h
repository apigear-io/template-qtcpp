...
*/
class OLinkTestApi54Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi54Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi54* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi54Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi54 that gets adapted to objectlink with OLinkTestApi54Adapter.
    */
    AbstractTestApi54* m_impl;
    /**
