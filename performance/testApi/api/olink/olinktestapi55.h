...
/**
* Adapts the general OLink Client handler to a TestApi55 in a way it provides access 
* to remote specific for TestApi55 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi55 to it.
* Use on client side to request changes of the TestApi55 on the server side 
* and to subscribe for the TestApi55 changes.
*/
class OLinkTestApi55 : public AbstractTestApi55, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi55(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi55() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi55 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi55.
