...
*/
class OLinkTestApi55Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi55Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi55* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi55Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi55 that gets adapted to objectlink with OLinkTestApi55Adapter.
    */
    AbstractTestApi55* m_impl;
    /**
