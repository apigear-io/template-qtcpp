...
/**
* Adapts the general OLink Client handler to a TestApi56 in a way it provides access 
* to remote specific for TestApi56 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi56 to it.
* Use on client side to request changes of the TestApi56 on the server side 
* and to subscribe for the TestApi56 changes.
*/
class OLinkTestApi56 : public AbstractTestApi56, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi56(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi56() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi56 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi56.
