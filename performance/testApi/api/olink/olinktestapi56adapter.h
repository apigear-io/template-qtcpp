...
*/
class OLinkTestApi56Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi56Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi56* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi56Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi56 that gets adapted to objectlink with OLinkTestApi56Adapter.
    */
    AbstractTestApi56* m_impl;
    /**
