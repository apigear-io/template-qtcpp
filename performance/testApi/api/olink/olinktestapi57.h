...
/**
* Adapts the general OLink Client handler to a TestApi57 in a way it provides access 
* to remote specific for TestApi57 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi57 to it.
* Use on client side to request changes of the TestApi57 on the server side 
* and to subscribe for the TestApi57 changes.
*/
class OLinkTestApi57 : public AbstractTestApi57, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi57(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi57() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi57 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi57.
