...
*/
class OLinkTestApi57Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi57Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi57* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi57Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi57 that gets adapted to objectlink with OLinkTestApi57Adapter.
    */
    AbstractTestApi57* m_impl;
    /**
