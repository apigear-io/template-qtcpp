...
/**
* Adapts the general OLink Client handler to a TestApi58 in a way it provides access 
* to remote specific for TestApi58 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi58 to it.
* Use on client side to request changes of the TestApi58 on the server side 
* and to subscribe for the TestApi58 changes.
*/
class OLinkTestApi58 : public AbstractTestApi58, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi58(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi58() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi58 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi58.
