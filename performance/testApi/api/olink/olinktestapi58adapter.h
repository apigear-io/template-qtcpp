...
*/
class OLinkTestApi58Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi58Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi58* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi58Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi58 that gets adapted to objectlink with OLinkTestApi58Adapter.
    */
    AbstractTestApi58* m_impl;
    /**
