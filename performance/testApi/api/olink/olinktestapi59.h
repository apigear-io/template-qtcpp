...
/**
* Adapts the general OLink Client handler to a TestApi59 in a way it provides access 
* to remote specific for TestApi59 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi59 to it.
* Use on client side to request changes of the TestApi59 on the server side 
* and to subscribe for the TestApi59 changes.
*/
class OLinkTestApi59 : public AbstractTestApi59, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi59(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi59() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi59 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi59.
