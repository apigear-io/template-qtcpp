...
*/
class OLinkTestApi59Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi59Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi59* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi59Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi59 that gets adapted to objectlink with OLinkTestApi59Adapter.
    */
    AbstractTestApi59* m_impl;
    /**
