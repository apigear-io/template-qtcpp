...
*/
class OLinkTestApi5Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi5Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi5* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi5Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi5 that gets adapted to objectlink with OLinkTestApi5Adapter.
    */
    AbstractTestApi5* m_impl;
    /**
