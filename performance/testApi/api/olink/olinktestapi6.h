...
/**
* Adapts the general OLink Client handler to a TestApi6 in a way it provides access 
* to remote specific for TestApi6 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi6 to it.
* Use on client side to request changes of the TestApi6 on the server side 
* and to subscribe for the TestApi6 changes.
*/
class OLinkTestApi6 : public AbstractTestApi6, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi6(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi6() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi6 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi6.
