...
/**
* Adapts the general OLink Client handler to a TestApi60 in a way it provides access 
* to remote specific for TestApi60 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi60 to it.
* Use on client side to request changes of the TestApi60 on the server side 
* and to subscribe for the TestApi60 changes.
*/
class OLinkTestApi60 : public AbstractTestApi60, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi60(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi60() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi60 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi60.
