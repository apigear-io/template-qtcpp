...
*/
class OLinkTestApi60Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi60Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi60* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi60Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi60 that gets adapted to objectlink with OLinkTestApi60Adapter.
    */
    AbstractTestApi60* m_impl;
    /**
