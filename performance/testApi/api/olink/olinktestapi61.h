...
/**
* Adapts the general OLink Client handler to a TestApi61 in a way it provides access 
* to remote specific for TestApi61 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi61 to it.
* Use on client side to request changes of the TestApi61 on the server side 
* and to subscribe for the TestApi61 changes.
*/
class OLinkTestApi61 : public AbstractTestApi61, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi61(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi61() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi61 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi61.
