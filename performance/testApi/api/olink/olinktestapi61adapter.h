...
*/
class OLinkTestApi61Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi61Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi61* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi61Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi61 that gets adapted to objectlink with OLinkTestApi61Adapter.
    */
    AbstractTestApi61* m_impl;
    /**
