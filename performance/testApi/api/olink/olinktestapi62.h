...
/**
* Adapts the general OLink Client handler to a TestApi62 in a way it provides access 
* to remote specific for TestApi62 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi62 to it.
* Use on client side to request changes of the TestApi62 on the server side 
* and to subscribe for the TestApi62 changes.
*/
class OLinkTestApi62 : public AbstractTestApi62, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi62(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi62() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi62 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi62.
