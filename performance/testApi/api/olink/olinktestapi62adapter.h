...
*/
class OLinkTestApi62Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi62Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi62* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi62Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi62 that gets adapted to objectlink with OLinkTestApi62Adapter.
    */
    AbstractTestApi62* m_impl;
    /**
