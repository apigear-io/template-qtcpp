...
/**
* Adapts the general OLink Client handler to a TestApi63 in a way it provides access 
* to remote specific for TestApi63 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi63 to it.
* Use on client side to request changes of the TestApi63 on the server side 
* and to subscribe for the TestApi63 changes.
*/
class OLinkTestApi63 : public AbstractTestApi63, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi63(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi63() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi63 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi63.
