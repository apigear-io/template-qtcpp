...
*/
class OLinkTestApi63Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi63Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi63* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi63Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi63 that gets adapted to objectlink with OLinkTestApi63Adapter.
    */
    AbstractTestApi63* m_impl;
    /**
