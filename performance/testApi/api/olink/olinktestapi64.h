...
/**
* Adapts the general OLink Client handler to a TestApi64 in a way it provides access 
* to remote specific for TestApi64 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi64 to it.
* Use on client side to request changes of the TestApi64 on the server side 
* and to subscribe for the TestApi64 changes.
*/
class OLinkTestApi64 : public AbstractTestApi64, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi64(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi64() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi64 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi64.
