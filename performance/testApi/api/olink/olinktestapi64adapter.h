...
*/
class OLinkTestApi64Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi64Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi64* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi64Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi64 that gets adapted to objectlink with OLinkTestApi64Adapter.
    */
    AbstractTestApi64* m_impl;
    /**
