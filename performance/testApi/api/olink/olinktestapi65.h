...
/**
* Adapts the general OLink Client handler to a TestApi65 in a way it provides access 
* to remote specific for TestApi65 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi65 to it.
* Use on client side to request changes of the TestApi65 on the server side 
* and to subscribe for the TestApi65 changes.
*/
class OLinkTestApi65 : public AbstractTestApi65, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi65(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi65() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi65 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi65.
