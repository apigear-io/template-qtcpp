...
*/
class OLinkTestApi65Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi65Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi65* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi65Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi65 that gets adapted to objectlink with OLinkTestApi65Adapter.
    */
    AbstractTestApi65* m_impl;
    /**
