...
/**
* Adapts the general OLink Client handler to a TestApi66 in a way it provides access 
* to remote specific for TestApi66 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi66 to it.
* Use on client side to request changes of the TestApi66 on the server side 
* and to subscribe for the TestApi66 changes.
*/
class OLinkTestApi66 : public AbstractTestApi66, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi66(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi66() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi66 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi66.
