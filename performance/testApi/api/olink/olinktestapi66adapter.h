...
*/
class OLinkTestApi66Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi66Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi66* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi66Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi66 that gets adapted to objectlink with OLinkTestApi66Adapter.
    */
    AbstractTestApi66* m_impl;
    /**
