...
/**
* Adapts the general OLink Client handler to a TestApi67 in a way it provides access 
* to remote specific for TestApi67 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi67 to it.
* Use on client side to request changes of the TestApi67 on the server side 
* and to subscribe for the TestApi67 changes.
*/
class OLinkTestApi67 : public AbstractTestApi67, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi67(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi67() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi67 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi67.
