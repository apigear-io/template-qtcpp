...
*/
class OLinkTestApi67Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi67Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi67* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi67Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi67 that gets adapted to objectlink with OLinkTestApi67Adapter.
    */
    AbstractTestApi67* m_impl;
    /**
