...
/**
* Adapts the general OLink Client handler to a TestApi68 in a way it provides access 
* to remote specific for TestApi68 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi68 to it.
* Use on client side to request changes of the TestApi68 on the server side 
* and to subscribe for the TestApi68 changes.
*/
class OLinkTestApi68 : public AbstractTestApi68, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi68(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi68() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi68 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi68.
