...
*/
class OLinkTestApi68Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi68Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi68* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi68Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi68 that gets adapted to objectlink with OLinkTestApi68Adapter.
    */
    AbstractTestApi68* m_impl;
    /**
