...
/**
* Adapts the general OLink Client handler to a TestApi69 in a way it provides access 
* to remote specific for TestApi69 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi69 to it.
* Use on client side to request changes of the TestApi69 on the server side 
* and to subscribe for the TestApi69 changes.
*/
class OLinkTestApi69 : public AbstractTestApi69, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi69(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi69() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi69 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi69.
