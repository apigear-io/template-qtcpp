...
*/
class OLinkTestApi69Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi69Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi69* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi69Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi69 that gets adapted to objectlink with OLinkTestApi69Adapter.
    */
    AbstractTestApi69* m_impl;
    /**
