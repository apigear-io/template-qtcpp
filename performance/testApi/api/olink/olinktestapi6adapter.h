...
*/
class OLinkTestApi6Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi6Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi6* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi6Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi6 that gets adapted to objectlink with OLinkTestApi6Adapter.
    */
    AbstractTestApi6* m_impl;
    /**
