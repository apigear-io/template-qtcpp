...
/**
* Adapts the general OLink Client handler to a TestApi7 in a way it provides access 
* to remote specific for TestApi7 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi7 to it.
* Use on client side to request changes of the TestApi7 on the server side 
* and to subscribe for the TestApi7 changes.
*/
class OLinkTestApi7 : public AbstractTestApi7, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi7(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi7() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi7 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi7.
