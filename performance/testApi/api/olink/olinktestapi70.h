...
/**
* Adapts the general OLink Client handler to a TestApi70 in a way it provides access 
* to remote specific for TestApi70 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi70 to it.
* Use on client side to request changes of the TestApi70 on the server side 
* and to subscribe for the TestApi70 changes.
*/
class OLinkTestApi70 : public AbstractTestApi70, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi70(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi70() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi70 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi70.
