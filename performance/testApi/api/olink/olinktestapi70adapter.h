...
*/
class OLinkTestApi70Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi70Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi70* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi70Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi70 that gets adapted to objectlink with OLinkTestApi70Adapter.
    */
    AbstractTestApi70* m_impl;
    /**
