...
/**
* Adapts the general OLink Client handler to a TestApi71 in a way it provides access 
* to remote specific for TestApi71 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi71 to it.
* Use on client side to request changes of the TestApi71 on the server side 
* and to subscribe for the TestApi71 changes.
*/
class OLinkTestApi71 : public AbstractTestApi71, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi71(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi71() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi71 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi71.
