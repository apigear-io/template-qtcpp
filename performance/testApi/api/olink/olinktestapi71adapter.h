...
*/
class OLinkTestApi71Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi71Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi71* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi71Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi71 that gets adapted to objectlink with OLinkTestApi71Adapter.
    */
    AbstractTestApi71* m_impl;
    /**
