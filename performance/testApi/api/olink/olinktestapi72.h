...
/**
* Adapts the general OLink Client handler to a TestApi72 in a way it provides access 
* to remote specific for TestApi72 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi72 to it.
* Use on client side to request changes of the TestApi72 on the server side 
* and to subscribe for the TestApi72 changes.
*/
class OLinkTestApi72 : public AbstractTestApi72, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi72(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi72() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi72 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi72.
