...
/**
* Adapts the general OLink Client handler to a TestApi73 in a way it provides access 
* to remote specific for TestApi73 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi73 to it.
* Use on client side to request changes of the TestApi73 on the server side 
* and to subscribe for the TestApi73 changes.
*/
class OLinkTestApi73 : public AbstractTestApi73, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi73(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi73() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi73 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi73.
