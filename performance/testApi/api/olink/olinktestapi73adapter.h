...
*/
class OLinkTestApi73Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi73Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi73* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi73Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi73 that gets adapted to objectlink with OLinkTestApi73Adapter.
    */
    AbstractTestApi73* m_impl;
    /**
