...
/**
* Adapts the general OLink Client handler to a TestApi74 in a way it provides access 
* to remote specific for TestApi74 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi74 to it.
* Use on client side to request changes of the TestApi74 on the server side 
* and to subscribe for the TestApi74 changes.
*/
class OLinkTestApi74 : public AbstractTestApi74, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi74(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi74() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi74 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi74.
