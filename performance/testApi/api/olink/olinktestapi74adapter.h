...
*/
class OLinkTestApi74Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi74Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi74* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi74Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi74 that gets adapted to objectlink with OLinkTestApi74Adapter.
    */
    AbstractTestApi74* m_impl;
    /**
