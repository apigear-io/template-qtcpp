...
/**
* Adapts the general OLink Client handler to a TestApi75 in a way it provides access 
* to remote specific for TestApi75 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi75 to it.
* Use on client side to request changes of the TestApi75 on the server side 
* and to subscribe for the TestApi75 changes.
*/
class OLinkTestApi75 : public AbstractTestApi75, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi75(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi75() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi75 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi75.
