...
*/
class OLinkTestApi75Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi75Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi75* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi75Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi75 that gets adapted to objectlink with OLinkTestApi75Adapter.
    */
    AbstractTestApi75* m_impl;
    /**
