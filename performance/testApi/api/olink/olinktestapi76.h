...
/**
* Adapts the general OLink Client handler to a TestApi76 in a way it provides access 
* to remote specific for TestApi76 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi76 to it.
* Use on client side to request changes of the TestApi76 on the server side 
* and to subscribe for the TestApi76 changes.
*/
class OLinkTestApi76 : public AbstractTestApi76, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi76(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi76() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi76 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi76.
