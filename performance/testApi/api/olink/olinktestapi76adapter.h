...
*/
class OLinkTestApi76Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi76Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi76* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi76Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi76 that gets adapted to objectlink with OLinkTestApi76Adapter.
    */
    AbstractTestApi76* m_impl;
    /**
