...
/**
* Adapts the general OLink Client handler to a TestApi77 in a way it provides access 
* to remote specific for TestApi77 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi77 to it.
* Use on client side to request changes of the TestApi77 on the server side 
* and to subscribe for the TestApi77 changes.
*/
class OLinkTestApi77 : public AbstractTestApi77, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi77(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi77() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi77 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi77.
