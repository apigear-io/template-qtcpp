...
*/
class OLinkTestApi77Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi77Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi77* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi77Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi77 that gets adapted to objectlink with OLinkTestApi77Adapter.
    */
    AbstractTestApi77* m_impl;
    /**
