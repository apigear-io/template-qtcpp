...
/**
* Adapts the general OLink Client handler to a TestApi78 in a way it provides access 
* to remote specific for TestApi78 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi78 to it.
* Use on client side to request changes of the TestApi78 on the server side 
* and to subscribe for the TestApi78 changes.
*/
class OLinkTestApi78 : public AbstractTestApi78, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi78(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi78() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi78 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi78.
