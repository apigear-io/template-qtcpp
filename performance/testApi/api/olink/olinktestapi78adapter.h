...
*/
class OLinkTestApi78Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi78Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi78* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi78Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi78 that gets adapted to objectlink with OLinkTestApi78Adapter.
    */
    AbstractTestApi78* m_impl;
    /**
