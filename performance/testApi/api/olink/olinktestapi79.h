...
/**
* Adapts the general OLink Client handler to a TestApi79 in a way it provides access 
* to remote specific for TestApi79 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi79 to it.
* Use on client side to request changes of the TestApi79 on the server side 
* and to subscribe for the TestApi79 changes.
*/
class OLinkTestApi79 : public AbstractTestApi79, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi79(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi79() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi79 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi79.
