...
*/
class OLinkTestApi79Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi79Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi79* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi79Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi79 that gets adapted to objectlink with OLinkTestApi79Adapter.
    */
    AbstractTestApi79* m_impl;
    /**
