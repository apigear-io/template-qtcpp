...
*/
class OLinkTestApi7Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi7Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi7* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi7Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi7 that gets adapted to objectlink with OLinkTestApi7Adapter.
    */
    AbstractTestApi7* m_impl;
    /**
