...
/**
* Adapts the general OLink Client handler to a TestApi8 in a way it provides access 
* to remote specific for TestApi8 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi8 to it.
* Use on client side to request changes of the TestApi8 on the server side 
* and to subscribe for the TestApi8 changes.
*/
class OLinkTestApi8 : public AbstractTestApi8, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi8(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi8() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi8 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi8.
