...
/**
* Adapts the general OLink Client handler to a TestApi80 in a way it provides access 
* to remote specific for TestApi80 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi80 to it.
* Use on client side to request changes of the TestApi80 on the server side 
* and to subscribe for the TestApi80 changes.
*/
class OLinkTestApi80 : public AbstractTestApi80, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi80(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi80() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi80 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi80.
