...
*/
class OLinkTestApi80Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi80Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi80* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi80Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi80 that gets adapted to objectlink with OLinkTestApi80Adapter.
    */
    AbstractTestApi80* m_impl;
    /**
