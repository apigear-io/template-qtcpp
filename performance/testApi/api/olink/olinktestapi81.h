...
/**
* Adapts the general OLink Client handler to a TestApi81 in a way it provides access 
* to remote specific for TestApi81 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi81 to it.
* Use on client side to request changes of the TestApi81 on the server side 
* and to subscribe for the TestApi81 changes.
*/
class OLinkTestApi81 : public AbstractTestApi81, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi81(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi81() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi81 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi81.
