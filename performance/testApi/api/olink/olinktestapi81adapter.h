...
*/
class OLinkTestApi81Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi81Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi81* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi81Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi81 that gets adapted to objectlink with OLinkTestApi81Adapter.
    */
    AbstractTestApi81* m_impl;
    /**
