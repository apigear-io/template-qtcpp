...
/**
* Adapts the general OLink Client handler to a TestApi82 in a way it provides access 
* to remote specific for TestApi82 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi82 to it.
* Use on client side to request changes of the TestApi82 on the server side 
* and to subscribe for the TestApi82 changes.
*/
class OLinkTestApi82 : public AbstractTestApi82, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi82(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi82() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi82 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi82.
