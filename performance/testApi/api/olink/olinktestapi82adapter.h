...
*/
class OLinkTestApi82Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi82Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi82* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi82Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi82 that gets adapted to objectlink with OLinkTestApi82Adapter.
    */
    AbstractTestApi82* m_impl;
    /**
