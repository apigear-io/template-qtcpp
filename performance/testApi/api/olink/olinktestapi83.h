...
/**
* Adapts the general OLink Client handler to a TestApi83 in a way it provides access 
* to remote specific for TestApi83 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi83 to it.
* Use on client side to request changes of the TestApi83 on the server side 
* and to subscribe for the TestApi83 changes.
*/
class OLinkTestApi83 : public AbstractTestApi83, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi83(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi83() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi83 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi83.
