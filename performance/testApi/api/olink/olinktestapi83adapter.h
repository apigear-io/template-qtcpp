...
*/
class OLinkTestApi83Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi83Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi83* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi83Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi83 that gets adapted to objectlink with OLinkTestApi83Adapter.
    */
    AbstractTestApi83* m_impl;
    /**
