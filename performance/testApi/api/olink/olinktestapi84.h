...
/**
* Adapts the general OLink Client handler to a TestApi84 in a way it provides access 
* to remote specific for TestApi84 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi84 to it.
* Use on client side to request changes of the TestApi84 on the server side 
* and to subscribe for the TestApi84 changes.
*/
class OLinkTestApi84 : public AbstractTestApi84, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi84(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi84() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi84 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi84.
