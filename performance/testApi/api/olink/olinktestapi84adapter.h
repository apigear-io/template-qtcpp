...
*/
class OLinkTestApi84Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi84Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi84* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi84Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi84 that gets adapted to objectlink with OLinkTestApi84Adapter.
    */
    AbstractTestApi84* m_impl;
    /**
