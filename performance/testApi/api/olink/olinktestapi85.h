...
/**
* Adapts the general OLink Client handler to a TestApi85 in a way it provides access 
* to remote specific for TestApi85 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi85 to it.
* Use on client side to request changes of the TestApi85 on the server side 
* and to subscribe for the TestApi85 changes.
*/
class OLinkTestApi85 : public AbstractTestApi85, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi85(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi85() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi85 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi85.
