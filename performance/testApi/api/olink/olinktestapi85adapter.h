...
*/
class OLinkTestApi85Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi85Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi85* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi85Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi85 that gets adapted to objectlink with OLinkTestApi85Adapter.
    */
    AbstractTestApi85* m_impl;
    /**
