...
/**
* Adapts the general OLink Client handler to a TestApi86 in a way it provides access 
* to remote specific for TestApi86 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi86 to it.
* Use on client side to request changes of the TestApi86 on the server side 
* and to subscribe for the TestApi86 changes.
*/
class OLinkTestApi86 : public AbstractTestApi86, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi86(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi86() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi86 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi86.
