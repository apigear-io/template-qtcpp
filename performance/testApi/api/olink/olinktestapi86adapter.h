...
*/
class OLinkTestApi86Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi86Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi86* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi86Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi86 that gets adapted to objectlink with OLinkTestApi86Adapter.
    */
    AbstractTestApi86* m_impl;
    /**
