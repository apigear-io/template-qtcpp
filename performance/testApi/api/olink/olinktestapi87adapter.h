...
*/
class OLinkTestApi87Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi87Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi87* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi87Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi87 that gets adapted to objectlink with OLinkTestApi87Adapter.
    */
    AbstractTestApi87* m_impl;
    /**
