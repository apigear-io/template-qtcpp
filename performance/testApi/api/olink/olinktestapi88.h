...
/**
* Adapts the general OLink Client handler to a TestApi88 in a way it provides access 
* to remote specific for TestApi88 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi88 to it.
* Use on client side to request changes of the TestApi88 on the server side 
* and to subscribe for the TestApi88 changes.
*/
class OLinkTestApi88 : public AbstractTestApi88, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi88(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi88() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi88 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi88.
