...
*/
class OLinkTestApi88Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi88Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi88* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi88Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi88 that gets adapted to objectlink with OLinkTestApi88Adapter.
    */
    AbstractTestApi88* m_impl;
    /**
