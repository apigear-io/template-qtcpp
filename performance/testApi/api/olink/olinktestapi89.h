...
/**
* Adapts the general OLink Client handler to a TestApi89 in a way it provides access 
* to remote specific for TestApi89 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi89 to it.
* Use on client side to request changes of the TestApi89 on the server side 
* and to subscribe for the TestApi89 changes.
*/
class OLinkTestApi89 : public AbstractTestApi89, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi89(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi89() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi89 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi89.
