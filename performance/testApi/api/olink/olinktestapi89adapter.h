...
*/
class OLinkTestApi89Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi89Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi89* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi89Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi89 that gets adapted to objectlink with OLinkTestApi89Adapter.
    */
    AbstractTestApi89* m_impl;
    /**
