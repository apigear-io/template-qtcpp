...
*/
class OLinkTestApi8Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi8Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi8* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi8Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi8 that gets adapted to objectlink with OLinkTestApi8Adapter.
    */
    AbstractTestApi8* m_impl;
    /**
