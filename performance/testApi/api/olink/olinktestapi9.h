...
/**
* Adapts the general OLink Client handler to a TestApi9 in a way it provides access 
* to remote specific for TestApi9 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi9 to it.
* Use on client side to request changes of the TestApi9 on the server side 
* and to subscribe for the TestApi9 changes.
*/
class OLinkTestApi9 : public AbstractTestApi9, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi9(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi9() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi9 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi9.
