...
/**
* Adapts the general OLink Client handler to a TestApi90 in a way it provides access 
* to remote specific for TestApi90 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi90 to it.
* Use on client side to request changes of the TestApi90 on the server side 
* and to subscribe for the TestApi90 changes.
*/
class OLinkTestApi90 : public AbstractTestApi90, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi90(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi90() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi90 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi90.
