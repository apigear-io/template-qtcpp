...
*/
class OLinkTestApi90Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi90Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi90* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi90Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi90 that gets adapted to objectlink with OLinkTestApi90Adapter.
    */
    AbstractTestApi90* m_impl;
    /**
