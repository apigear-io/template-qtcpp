...
/**
* Adapts the general OLink Client handler to a TestApi91 in a way it provides access 
* to remote specific for TestApi91 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi91 to it.
* Use on client side to request changes of the TestApi91 on the server side 
* and to subscribe for the TestApi91 changes.
*/
class OLinkTestApi91 : public AbstractTestApi91, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi91(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi91() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi91 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi91.
