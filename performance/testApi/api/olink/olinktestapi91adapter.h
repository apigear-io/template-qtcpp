...
*/
class OLinkTestApi91Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi91Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi91* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi91Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi91 that gets adapted to objectlink with OLinkTestApi91Adapter.
    */
    AbstractTestApi91* m_impl;
    /**
