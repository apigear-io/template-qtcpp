...
/**
* Adapts the general OLink Client handler to a TestApi92 in a way it provides access 
* to remote specific for TestApi92 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi92 to it.
* Use on client side to request changes of the TestApi92 on the server side 
* and to subscribe for the TestApi92 changes.
*/
class OLinkTestApi92 : public AbstractTestApi92, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi92(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi92() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi92 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi92.
