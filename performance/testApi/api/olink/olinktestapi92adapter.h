...
*/
class OLinkTestApi92Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi92Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi92* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi92Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi92 that gets adapted to objectlink with OLinkTestApi92Adapter.
    */
    AbstractTestApi92* m_impl;
    /**
