...
/**
* Adapts the general OLink Client handler to a TestApi93 in a way it provides access 
* to remote specific for TestApi93 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi93 to it.
* Use on client side to request changes of the TestApi93 on the server side 
* and to subscribe for the TestApi93 changes.
*/
class OLinkTestApi93 : public AbstractTestApi93, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi93(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi93() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi93 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi93.
