...
*/
class OLinkTestApi93Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi93Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi93* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi93Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi93 that gets adapted to objectlink with OLinkTestApi93Adapter.
    */
    AbstractTestApi93* m_impl;
    /**
