...
/**
* Adapts the general OLink Client handler to a TestApi94 in a way it provides access 
* to remote specific for TestApi94 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi94 to it.
* Use on client side to request changes of the TestApi94 on the server side 
* and to subscribe for the TestApi94 changes.
*/
class OLinkTestApi94 : public AbstractTestApi94, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi94(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi94() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi94 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi94.
