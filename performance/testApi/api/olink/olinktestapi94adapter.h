...
*/
class OLinkTestApi94Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi94Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi94* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi94Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi94 that gets adapted to objectlink with OLinkTestApi94Adapter.
    */
    AbstractTestApi94* m_impl;
    /**
