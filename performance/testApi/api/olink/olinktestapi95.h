...
/**
* Adapts the general OLink Client handler to a TestApi95 in a way it provides access 
* to remote specific for TestApi95 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi95 to it.
* Use on client side to request changes of the TestApi95 on the server side 
* and to subscribe for the TestApi95 changes.
*/
class OLinkTestApi95 : public AbstractTestApi95, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi95(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi95() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi95 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi95.
