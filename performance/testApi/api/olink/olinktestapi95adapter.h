...
*/
class OLinkTestApi95Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi95Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi95* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi95Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi95 that gets adapted to objectlink with OLinkTestApi95Adapter.
    */
    AbstractTestApi95* m_impl;
    /**
