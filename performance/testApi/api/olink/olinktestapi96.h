...
/**
* Adapts the general OLink Client handler to a TestApi96 in a way it provides access 
* to remote specific for TestApi96 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi96 to it.
* Use on client side to request changes of the TestApi96 on the server side 
* and to subscribe for the TestApi96 changes.
*/
class OLinkTestApi96 : public AbstractTestApi96, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi96(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi96() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi96 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi96.
