...
*/
class OLinkTestApi96Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi96Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi96* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi96Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi96 that gets adapted to objectlink with OLinkTestApi96Adapter.
    */
    AbstractTestApi96* m_impl;
    /**
