...
/**
* Adapts the general OLink Client handler to a TestApi97 in a way it provides access 
* to remote specific for TestApi97 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi97 to it.
* Use on client side to request changes of the TestApi97 on the server side 
* and to subscribe for the TestApi97 changes.
*/
class OLinkTestApi97 : public AbstractTestApi97, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi97(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi97() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi97 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi97.
