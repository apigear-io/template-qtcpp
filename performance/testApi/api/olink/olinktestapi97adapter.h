...
*/
class OLinkTestApi97Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi97Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi97* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi97Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi97 that gets adapted to objectlink with OLinkTestApi97Adapter.
    */
    AbstractTestApi97* m_impl;
    /**
