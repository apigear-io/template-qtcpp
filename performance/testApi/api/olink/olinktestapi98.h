...
/**
* Adapts the general OLink Client handler to a TestApi98 in a way it provides access 
* to remote specific for TestApi98 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi98 to it.
* Use on client side to request changes of the TestApi98 on the server side 
* and to subscribe for the TestApi98 changes.
*/
class OLinkTestApi98 : public AbstractTestApi98, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi98(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi98() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi98 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi98.
