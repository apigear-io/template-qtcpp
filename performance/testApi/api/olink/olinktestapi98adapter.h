...
*/
class OLinkTestApi98Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi98Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi98* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi98Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi98 that gets adapted to objectlink with OLinkTestApi98Adapter.
    */
    AbstractTestApi98* m_impl;
    /**
