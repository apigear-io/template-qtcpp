...
/**
* Adapts the general OLink Client handler to a TestApi99 in a way it provides access 
* to remote specific for TestApi99 services (properties, signals, methods). 
...
*     It provides a network implementation and tools to connect OLinkTestApi99 to it.
* Use on client side to request changes of the TestApi99 on the server side 
* and to subscribe for the TestApi99 changes.
*/
class OLinkTestApi99 : public AbstractTestApi99, public IObjectSink
{
    Q_OBJECT
public:
    /** ctor */
    explicit OLinkTestApi99(QObject *parent = nullptr);
    /** dtor */
    ~OLinkTestApi99() override = default;
    /**
    * Property getter
...
signals:
    ...
    /**
    * Informs if the OLinkTestApi99 is ready to send and receive messages.
    */
    void isReady();
public:
...
private:
    ...
    */
    ...
    bool m_isReady;
    /** 
    * An abstraction layer over the connection with service for the OLinkTestApi99.
