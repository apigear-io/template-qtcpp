...
*/
class OLinkTestApi99Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi99Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi99* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi99Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi99 that gets adapted to objectlink with OLinkTestApi99Adapter.
    */
    AbstractTestApi99* m_impl;
    /**
