...
*/
class OLinkTestApi9Adapter : public QObject, public ApiGear::ObjectLink::IObjectSource
{
    Q_OBJECT
public:
    /**
    ...
    */
    explicit OLinkTestApi9Adapter(ApiGear::ObjectLink::RemoteRegistry& registry, AbstractTestApi9* impl, QObject *parent = nullptr);
    virtual ~OLinkTestApi9Adapter() = default;
public:
    /**
...
private:
    /**
    * The actual implementation of a TestApi9 that gets adapted to objectlink with OLinkTestApi9Adapter.
    */
    AbstractTestApi9* m_impl;
    /**
