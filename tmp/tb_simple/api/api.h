...
public:
    ...
    virtual void setPropFloat(double propFloat) = 0;
    virtual double propFloat() const = 0;
    ...
    virtual double funcFloat(double paramFloat) = 0;
...
public:
    ...
    virtual void setPropFloat(const QList<double>& propFloat) = 0;
    virtual QList<double> propFloat() const = 0;
    ...
    virtual QList<double> funcFloat(const QList<double>& paramFloat) = 0;
